...
$jscomp.polyfill("Array.prototype.includes",function(b){return b?b:function(b,f){var a=this;a instanceof String&&(a=String(a));var e=a.length;for(f=f||0;f<e;f++)if(a[f]==b||Object.is(a[f],b))return!0;return!1}},"es7","es3");
...
$jscomp.polyfill("String.prototype.startsWith",function(b){return b?b:function(b,f){var a=$jscomp.checkStringArgs(this,b,"startsWith");b+="";var e=a.length,g=b.length;f=Math.max(0,Math.min(f|0,a.length));for(var m=0;m<g&&f<e;)if(a[f++]!=b[m++])return!1;return m>=g}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};
...
$jscomp.polyfill("Array.prototype.entries",function(b){return b?b:function(){return $jscomp.iteratorFromArray(this,function(b,f){return[b,f]})}},"es6","es3");$jscomp.polyfill("Array.prototype.values",function(b){return b?b:function(){return $jscomp.iteratorFromArray(this,function(b,f){return f})}},"es6","es3");
(function(b,d){if(void 0===b.d3wb.util)throw Error("d3wb.util required but not loaded.");"object"===typeof exports&&"undefined"!==typeof module?d(exports):"function"===typeof define&&define.amd?define(["exports"],d):d(b.d3wb.add=b.d3wb.add||{})})(this,function(b){var d=function(b){var g="red",e=d3.axisTop,h=0,c=void 0,k=function(k){k.each(function(k,l,p){a(g,"wb-axis-x");k=d3.select(p[l]).append("g").attr("transform","translate(0,"+h+")").attr("class","wb-axis wb-axis-x").call(e(b));90==c&&k.selectAll("text").attr("y",
-2).attr("x",-9).attr("dy",".35em").style("text-anchor","end").attr("transform","rotate(-90)")})};k.type=function(a){if(!arguments.length)return e;e=a;return k};k.y=function(a){if(!arguments.length)return h;h=a;return k};k.color=function(a){if(!arguments.length)return g;g=a;return k};k.rotation=function(a){if(!arguments.length)return c;c=a;return k};k.scale=function(a){if(!arguments.length)return b;b=a;return k};k.fontSize=function(a){d3wb.util.injectCSS("\n                .wb-axis-x text {\n                  font-size: "+
a+";\n              }");return k};return k},f=function(b){var g="red",e=d3.axisLeft,h=0,c=function(a){return a},k=function(){},f,d=function(l){l.each(function(p,l,d){a(g,"wb-axis-y");f=d3.select(d[l]).append("g").attr("class","wb-axis wb-axis-y").attr("transform","translate("+h+",0)");k=function(a){f.call(c(e(a)))};k(b)})};d.update=function(a){k(a);return d};d.format=function(a){if(!arguments.length)return c;c=a;return d};d.type=function(a){if(!arguments.length)return e;e=a;return d};d.x=function(a){if(!arguments.length)return h;
h=a;return d};d.color=function(a){if(!arguments.length)return g;g=a;return d};d.scale=function(a){if(!arguments.length)return b;b=a;return d};d.fontSize=function(a){d3wb.util.injectCSS("\n                .wb-axis-y text {\n                  font-size: "+a+";\n              }");return d};return d};d3wb.add={xAxis:d,xAxisBottom:function(a){return d(a).type(d3.axisBottom)},xAxisLabel:function(a){var b="red",e="top",h=function(c){c.each(function(c,g,h){c=d3.select(h[g].ownerSVGElement);var k=c.node().getBBox();
c.append("text").attr("transform",function(){var a="translate("+k.width/2+",";a="top"==e?a+15:a+(k.height-15);return a+")"}).style("text-anchor","middle").style("fill",b).attr("dominant-baseline",function(){return"top"==e?"hanging":"auto"}).text(a)})};h.color=function(a){if(!arguments.length)return b;b=a;return h};h.orientation=function(a){if(!arguments.length)return e;e=a;return h};return h},yAxis:f,yAxisRight:function(a){return f(a).type(d3.axisRight)},yAxisLabel:function(a){var b="red",e="left",
h=function(c){c.each(function(c,g,h){c=d3.select(h[g].ownerSVGElement);var k=c.node().getBBox();c.append("text").attr("transform",function(){var a="translate(";a="left"==e?a+5:a+(k.width-5);a+=","+k.height/2+") rotate(";a="left"==e?a+"-90":a+"90";return a+")"}).style("text-anchor","middle").attr("dominant-baseline","hanging").style("fill",b).text(a)})};h.color=function(a){if(!arguments.length)return b;b=a;return h};h.orientation=function(a){if(!arguments.length)return e;e=a;return h};return h},title:function(a){var b=
"red",e="140%",h=function(){},c=function(c){c.each(function(c,g,k){var p=d3.select(k[g].ownerSVGElement);c=p.node().getBBox();p.append("text").attr("class","wb-title").attr("x",c.width/2).attr("y",5).attr("text-anchor","middle").attr("dominant-baseline","hanging").style("pointer-events","none").style("fill",b).style("font-size",e);h=function(){p.selectAll(".wb-title").text(a)};h()})};c.color=function(a){if(!arguments.length)return b;b=a;return c};c.fontSize=function(a){if(!arguments.length)return e;
e=a;return c};c.text=function(b){if(!arguments.length)return a;a=b;return c};c.update=function(){h()};return c},shadow:function(){var a=d3wb.util.guid();return function(b){b.each(function(b,e,c){b=d3.select(c[e]);e=d3.select(c[e].ownerSVGElement).append("defs").append("filter").attr("id",a);e.append("feGaussianBlur").attr("in","SourceAlpha").attr("stdDeviation",3).attr("result","blur");e.append("feOffset").attr("in","blur").attr("dx",2).attr("dy",1).attr("result","offsetBlur");e.append("feComponentTransfer").append("feFuncA").attr("type",
"linear").attr("slope",.4);e=e.append("feMerge");e.append("feMergeNode").attr('in", "offsetBlur');e.append("feMergeNode").attr("in","SourceGraphic");b.style("filter","url(#"+a+")")})}},legend:function(){var a="white",b,d=["red","green","blue"],f=["Item 1","Item 2","Item 3"],c=0,k=0,n=d3.symbolCircle,q=100,l=function(e){e.each(function(e,p,g){e=d3.select(g[p]);e.append("g").attr("class","legend").attr("transform","translate("+c+","+k+")");p=d3.scaleOrdinal().domain(f.map(function(a){return a})).range(f.map(function(a,
b){return d[b]}));p=d3.legendColor().shape("path",d3.symbol().type(n).size(q)()).scale(p);e.select(".legend").call(p).style("fill",a).style("font-size","90%");b&&e.selectAll("path.swatch").style("stroke",b)})};l.stroke=function(a){if(!arguments.length)return b;b=a;return l};l.x=function(a){if(!arguments.length)return c;c=a;return l};l.y=function(a){if(!arguments.length)return k;k=a;return l};l.text=function(a){if(!arguments.length)return f;f=a;return l};l.colors=function(a){if(!arguments.length)return d;
d=a;return l};l.color=function(b){if(!arguments.length)return a;a=b;return l};l.symbol=function(a){if(!arguments.length)return n;n=a;return l};l.symbolSize=function(a){if(!arguments.length)return q;q=a;return l};return l}};var a=function(a,b){d3wb.util.injectCSS("\n            ."+b+" line{\n              stroke: "+a+";\n            }\n            ."+b+" path{\n              stroke: "+a+";\n            }\n            ."+b+" text{\n              fill: "+a+";\n            }\n            ")}});
(function(b,d){if(void 0===b.d3wb.util)throw Error("d3wb.util required but not loaded.");"object"===typeof exports&&"undefined"!==typeof module?d(exports):"function"===typeof define&&define.amd?define(["exports"],d):d(b.d3wb.html=b.d3wb.html||{})})(this,function(b){d3wb.html={dropdown:function(){var a=["Option 1","Option 2","Option 3"],b=function(b){b=d(b);b.each(function(b,c,e){b=function(){var b=d3.select("#"+g.id).property("value"),c=a.indexOf(b);g.callback(b,c)};d3.select(e[c]).append("select").attr("id",
g.id).on("change",b).selectAll("option").data(a).enter().append("option").text(function(a){return a});d3wb.util.injectCSS("\n                        #"+g.id+" {\n                            position: absolute;\n                        }\n                    ");b()})},g=f(b);b.options=function(e){if(!arguments.length)return a;a=e;return b};return b},button:function(){var a=["Click me"],b=0,g,m=function(c){c=d(c);c.each(function(c,e,d){c=function(){var c=d3.select("#"+h.id).text(),e=a.indexOf(c);b=
(b+1)%a.length;h.callback(c,e);g.text(a[b])};g=d3.select(d[e]).append("button").attr("id",h.id).text(a[b]).on("click",c);d3wb.util.injectCSS("\n                        #"+h.id+" {\n                            position: absolute;\n                        }\n                    ");h.callbackOnInit&&c()})},h=f(m);m.options=function(b){if(!arguments.length)return a;a=b;return m};return m},textfield:function(){var a=function(a){a=d(a);a.each(function(a,e,c){d3.select(c[e]).append("input").attr("id",b.id).on("input",
function(a,c,e){b.callback(e[c].value)});d3wb.util.injectCSS("\n                        #"+b.id+" {\n                            position: absolute;\n                        }\n                    ")})},b=f(a);return a},infoBox:function(){var a="white",b="yellow",g="white",m=g,h="black",c="\x3cb\x3eInformation\x3c/b\x3e\x3c/br\x3e\n        This box contains information about the graph. It's intended to guide the user. You can use \x3ci\x3ehtml-style\x3c/i\x3e as desired.\n        ",k=!1,n=function(e){e=
d(e);e.each(function(e,d,f){e=d3.select(f[d]).append("div").attr("id",q.id);d=e.append("p").attr("id",q.id+"-in").html("\x26#9432;");e.append("p").attr("id",q.id+"-ib").html(c);d.on("click",function(){k=!k;d3wb.util.injectCSS("#"+q.id+"-ib { opacity: "+(k?.9:0)+";}")});d3wb.util.injectCSS("\n                    #"+q.id+" {\n                        position: absolute;\n                        margin: 0;\n                        padding: 0;\n                        pointer-events:none;\n                    }\n                    #"+
q.id+"-in {\n                        position: relative;\n                        text-align: left;\n                        width: 0;\n                        -webkit-touch-callout: none;\n                        -webkit-user-select: none;\n                        -khtml-user-select: none;\n                        -moz-user-select: none;\n                        -ms-user-select: none;\n                        user-select: none;\n                        margin: 0;\n                        padding: 0;\n                        color: "+
a+";\n                        font-size: 150%;\n                        pointer-events: auto;\n                    }\n                    #"+q.id+"-in:hover {\n                        cursor: default;\n                        color: "+b+";\n                    }\n                    #"+q.id+"-ib {\n                        position: relative;\n                        text-align: left;\n                        -webkit-touch-callout: none;\n                        -webkit-user-select: none;\n                        -khtml-user-select: none;\n                        -moz-user-select: none;\n                        -ms-user-select: none;\n                        user-select: none;\n                        margin: 0;\n                        padding: 0.5em;\n                        border-radius: 0.4em;\n                        border: 1px solid "+
m+";\n                        color: "+g+";\n                        font-size: 100%;\n                        background-color: "+h+";\n                        opacity: 0;\n                    }\n                ")})},q=f(n);n.controlColor=function(b){if(!arguments.length)return a;a=b;return n};n.controlColorHover=function(a){if(!arguments.length)return b;b=a;return n};n.controlHover=function(a){if(!arguments.length)return controlHover;controlHover=a;return n};n.infoColor=function(a){if(!arguments.length)return g;
g=a;return n};n.infoFill=function(a){if(!arguments.length)return h;h=a;return n};n.infoContent=function(a){if(!arguments.length)return c;c=a;return n};return n}};var d=function(a){return void 0!==a.div?a.div:a},f=function(a){var b={id:d3wb.util.websafeGuid(),div:d3.select("body"),callback:function(){console.log("callback.")},callbackOnInit:!1};a.id=function(e){if(!arguments.length)return"#"+b.id;id=e;return a};a.style=function(e,d){d3wb.util.injectCSS("\n                        #"+b.id+" {\n                            "+
e+": "+d+";\n                        }\n                    ");return a};a.callback=function(e){if(!arguments.length)return b.callback;b.callback=e;return a};return b}});
(function(b,d){"object"===typeof exports&&"undefined"!==typeof module?d(exports):"function"===typeof define&&define.amd?define(["exports"],d):d(b.d3wb.mouse=b.d3wb.mouse||{})})(this,function(b){d3wb.mouse={tooltip:function(){var b=.8,f=5,a="white",e="black",g=20,m=5,h=function(){return(new Date).toDateString()+"\n"+String(Math.floor(9E8*Math.random()))},c=function(c){c.each(function(c,d,k){c=d3.select(k[d]);var p=k[d].ownerSVGElement,t=p.getBBox(),u=!1,n,l,q;c.on("mouseover",function(c){if(!u){u=
!0;n=d3.select(p).append("g").style("pointer-events","none").style("user-select","none").style("-moz-user-select","none");l=n.append("rect");q=n.append("text");c=(""+h(c)).split("\n");var d={};for(k in c)d.i$0=k,Object.prototype.hasOwnProperty.call(c,d.i$0)&&(q.append("tspan").style("text-anchor","middle").style("dominant-baseline","hanging").style("fill",a).attr("x",0).attr("dy",function(a){return function(){return 0==a.i$0?0:g}}(d)).text(c[d.i$0]),d={i$0:d.i$0});var k=q.node().getBBox();l.attr("rx",
m).attr("ry",m).attr("width",k.width+2*f).attr("height",k.height+2*f).attr("x",-(k.width/2)-f).attr("y",-f).attr("opacity",b).style("fill",e)}});c.on("mouseout",function(){u&&(u=!1,n.remove())});c.on("mousemove",function(){var a=d3.mouse(p),b=l.node().getBBox(),c=a[0];a=a[1]-b.height;c=0>c-b.width/2?b.width/2:c;c=c+b.width/2>t.width?t.width-b.width/2:c;a=0>a-f?f:a;a=a+b.height-f>t.height?t.height-b.height+f:a;n.attr("transform","translate("+c+","+a+")")})})};c.opacity=function(a){if(!arguments.length)return b;
b=a;return c};c.padding=function(a){if(!arguments.length)return f;f=a;return c};c.color=function(b){if(!arguments.length)return a;a=b;return c};c.fill=function(a){if(!arguments.length)return e;e=a;return c};c.lineHeight=function(a){if(!arguments.length)return g;g=a;return c};c.roundCorners=function(a){if(!arguments.length)return m;m=a;return c};c.selector=function(a){if(!arguments.length)return h;h=a;return c};return c},click:function(){var b=["dblclick"],f=["open"],a="dblclick",e="open",g=function(a,
b){return"https://d3js.org/"},m=function(b){b.each(function(b,c,d){b=d3.select(d[c]);h(e,a,b)})},h=function(a,b,e){if("open"==a)e.on(b,function(a,b){a=g(a,b);window.open(a,"_blank")})};m.event=function(c){if(!arguments.length)return a;if(!b.includes(c))throw Error("Event '"+c+"' not supported! Allowed: "+b);a=c;return m};m.action=function(a){if(!arguments.length)return e;if(!f.includes(a))throw Error("Action '"+a+"' not supported! Allowed: "+f);e=a;return m};m.openTarget=function(a){if(!arguments.length)return g;
g=a;return m};return m}}});
(function(b,d){"object"===typeof exports&&"undefined"!==typeof module?d(exports):"function"===typeof define&&define.amd?define(["exports"],d):d(b.d3wb.theme=b.d3wb.theme||{})})(this,function(b){var d={dark:{background:"#1D1F21",black:"#282A2E",blue:"#5F819D",cyan:"#5E8D87",foreground:"#C5C8C6",green:"#8C9440",magenta:"#85678F",red:"#A54242",white:"#707880",yellow:"#DE935F"},gotham:{background:"#0A0F14",black:"#0A0F14",blue:"#195465",cyan:"#33859D",foreground:"#98D1CE",green:"#26A98B",magenta:"#4E5165",
red:"#C33027",white:"#98D1CE",yellow:"#EDB54B"},light:{background:"#FFFFFF",black:"#000000",blue:"#87AFDF",cyan:"#AFDFDF",foreground:"#1A1D1D",green:"#AFD787",magenta:"#DFAFDF",red:"#D78787",white:"#FFFFFF",yellow:"#FFFFAF"},monokai:{background:"#272822",black:"#272822",blue:"#66D9EF",cyan:"#A1EFE4",foreground:"#F8F8F2",green:"#A6E22E",magenta:"#AE81FF",red:"#F92672",white:"#F8F8F2",yellow:"#F4BF75"},ocean:{background:"#2B303B",black:"#2B303B",blue:"#8FA1B3",cyan:"#96B5B4",foreground:"#C0C5CE",green:"#A3BE8C",
magenta:"#B48EAD",red:"#BF616A",white:"#C0C5CE",yellow:"#EBCB8B"},sweetlove:{background:"#1F1F1F",black:"#4A3637",blue:"#535C5C",cyan:"#6D715E",foreground:"#C0B18B",green:"#7B8748",magenta:"#775759",red:"#D17B49",white:"#C0B18B",yellow:"#AF865A"},tomorrowlight:{background:"#FFFFFF",black:"#1D1F21",blue:"#81A2BE",cyan:"#8ABEB7",foreground:"#373B41",green:"#B5BD68",magenta:"#B294BB",red:"#CC6666",white:"#C5C8C6",yellow:"#F0C674"},yousay:{background:"#F5E7DE",black:"#666661",blue:"#4C7399",cyan:"#D97742",
foreground:"#34302D",green:"#4C3226",magenta:"#BF9986",red:"#992E2E",white:"#34302D",yellow:"#A67C53"}},f=function(a){for(var b=[],c=0;c<a.length;c++)a[c].startsWith("#")?b.push(""+d3.rgb(a[c])):b.push(""+d3wb.color(a[c]));return b},a=function(){for(var a=["blue","red","green","magenta","foreground"],b=[],c=0;c<a.length;c++){var e=d3wb.color.lohiScaleArray(a[c],5,[.6,.6]);b=b.concat(e)}return b},e=function(){for(var a="blue cyan green magenta red yellow foreground".split(" "),b=[],c=0;c<a.length;c++)b.push(l(a[c]));
return b},g=function(a,b,c,e){a=l(a);b=l(b);a=d3.interpolateRgb(a,b);e=e||[0,1];if(2>=c)a=[a(0),a(1)];else{c=(e[1]-e[0])/c;b=e[0]+c;var d=[];d.push(a(e[0]));do d.push(a(b)),b+=c;while(b<e[1]-c-.0001);d.push(a(e[1]));a=d}return a},m=function(a,b,c){c=c||[.4,.7];var e=0==b%2;b=e?b/2:(b+1)/2;e=g("black",a,e?b+1:b,[c[0],1]);a=g(a,"white",b,[0,c[1]]);return e.concat(a.slice(1))},h=function(){return d3.scaleOrdinal(d3wb.color.category())},c=function(){for(var a=[],b=2;25>b;b+=5)a.push(d3wb.color.category()[b]);
return d3.scaleOrdinal(a)},k=function(a,b){b=b||[d3wb.color.white,d3wb.color.black];return d3.scaleLinear().domain(a).interpolate(d3.interpolate).range(b)},n=function(a,b){return d3.scaleQuantile().domain(a).range(b)},q=function(a,b){a.name=b;a.fade=function(b){return m(a.name,100)[b]};return a},l=function(a){var b=a;"string"!==typeof a||a.startsWith("rgb")||(a=d3.rgb(d3wb.color[a]),a=q(a,b));return a};d3wb.theme=function(b){if(!arguments.length){var l=Object.keys(d3wb.color),p=[];for(r in l)"function"!==
typeof d3wb.color[l[r]]&&p.push(d3wb.color[l[r]].name);return p}var r=d[b];p={lohiScaleArray:m,array:f,gradientArray:g,category:a,categoryMain:e,quantile:n,linearGradient:k,ordinal:h,smallOrdinal:c};for(l in r)Object.prototype.hasOwnProperty.call(r,l)&&(p[l]=d3.rgb(r[l]),p[l]=q(p[l],l));d3wb.color=p};d3wb.theme("light")});
(function(b,d){if(void 0===b.d3wb)throw Error("d3wb required but not loaded.");"object"===typeof exports&&"undefined"!==typeof module?d(exports):"function"===typeof define&&define.amd?define(["exports"],d):d(b.d3wb.util=b.d3wb.util||{})})(this,function(b){var d=function(){return f()+f()+"-"+f()+"-"+f()+"-"+f()+"-"+f()+f()+f()};d3wb.util={setLocale:function(a){if("de"==a)d3.timeFormat=d3.timeFormatLocale({dateTime:"%A, der %e. %B %Y, %X",date:"%d.%m.%Y",time:"%H:%M:%S",periods:["AM","PM"],days:"Sonntag Montag Dienstag Mittwoch Donnerstag Freitag Samstag".split(" "),
shortDays:"So Mo Di Mi Do Fr Sa".split(" "),months:"Januar Februar M\u00e4rz April Mai Juni Juli August September Oktober November Dezember".split(" "),shortMonths:"Jan Feb Mrz Apr Mai Jun Jul Aug Sep Okt Nov Dez".split(" ")}).format;else throw Error("Unsupported locale.");},changeCSVSeparator:function(a){d3.csv=function(b,d){d3.request(b).mimeType("text/csv").response(function(b){return d3.dsvFormat(a).parse(b.responseText)}).get(d)}},smoothData:function(a,b,d,f){var e=[],c=[];a.forEach(function(b,
g){g+=1;e.push(b[d]);if(0==g%f||g==a.length)b=d3.median(e),c.push(b),e=[]});var g=[],n=0,m=0,l;for(l in c)if(Object.prototype.hasOwnProperty.call(c,l)){n+=f;for(var p=n>a.length?a.length%f:f,t=d3.interpolate(0==l?a[0][d]:c[l-1],c[l]),u=1/p,r=0,w=0;w<p;w++){r+=u;var v={};v[b]=a[m][b];v[d]=t(r);g.push(v);m+=1}}return g},countCsvColumn:function(a,b,d,f){d=void 0===d?!0:d;a=d3.nest().key(function(a){return a[b]}).entries(a);void 0!==f&&0<f.length&&(a=a.filter(function(a){return!f.includes(a.key)}));for(var e=
[],c=0;c<a.length;c++)e.push({label:a[c].key,count:+a[c].values.length});var g=d3.sum(e,function(a){return+a.count});e.forEach(function(a){a.percent=+a.count/g*100});d&&e.sort(function(a,b){return b.percent-a.percent});return e},guid:d,websafeGuid:function(){return"d3wb-"+d()},injectCSS:function(a){var b=document.getElementsByTagName("head")[0],d=document.createElement("style");d.styleSheet?d.styleSheet.cssText=a:d.appendChild(document.createTextNode(a));b.appendChild(d)},logSVGSize:function(a){a=
a.ownerSVGElement.getBBox();console.log(a.x+" x "+a.y+" | "+a.width+" x "+a.height)},jsonAttributeMapToCSV:function(a){var b=["key"],d=a[Object.keys(a)[0]];for(h in d)Object.prototype.hasOwnProperty.call(d,h)&&b.push(h);d=['"'+b.join('","')+'"'];for(var f in a)if(Object.prototype.hasOwnProperty.call(a,f)){var h=[f];for(var c in b)0!=c&&h.push(a[f][b[c]]);d.push('"'+h.join('","')+'"')}a=d.join("\n");return d3.csvParse(a)},getBoundingBoxCenter:function(a){a=d3.select(a).node().getBBox();return[a.x+
a.width/2,a.y+a.height/2]}};var f=function(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}});
...
a.value]})};c.prototype.keys=function(){return e(this,function(a){return a.key})};c.prototype.values=function(){return e(this,function(a){return a.value})};c.prototype.forEach=function(a,c){for(var g=this.entries(),b;!(b=g.next()).done;)b=b.value,a.call(c,b[1],b[0],this)};c.prototype[Symbol.iterator]=c.prototype.entries;var f=function(a,b){var g=b&&typeof b;"object"==g||"function"==g?d.has(b)?g=d.get(b):(g=""+ ++k,d.set(b,g)):g="p_"+b;var c=a.data_[g];if(c&&$jscomp.owns(a.data_,g))for(a=0;a<c.length;a++){var f=
c[a];if(b!==b&&f.key!==f.key||b===f.key)return{id:g,list:c,index:a,entry:f}}return{id:g,list:c,index:-1,entry:void 0}},e=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},b=function(){var a={};return a.previous=a.next=a.head=a},k=0;return c},"es6","es3");
...
var wbBarChart=function(){var a=500,d=500,c=.1,f=1,e="x",b="y",k,u,q,g,t="desc",l,m="black",h=function(a){return a},x="blue",w=function(){},p=function(n){n.each(function(n,p,C){var v=d3.select(C[p]);k=d3.scaleBand().rangeRound([0,a],.1).padding(c);u=d3.scaleLinear().range([d,0]);w=function(a){a.forEach(function(a){a[b]=+a[b]});g&&a.sort(function(a,b){return"desc"==t?+b[g]-+a[g]:+a[g]-+b[g]});var c=q?q:[0,d3.max(a,function(a){return a[b]})];u.domain(c);k.domain(a.map(function(a){return a[e]}));v.selectAll(".rects").remove().exit().data(a).enter().append("rect").attr("class",
"rects").attr("x",function(a){if(1<=f)return k(a[e]);var b=k.bandwidth()-k.bandwidth()*f;return k(a[e])+b/2}).attr("width",function(a){return k.bandwidth()*f}).attr("y",function(a){return u(a[b])}).attr("height",function(a){return d-u(a[b])}).attr("fill",function(a,b){return"string"===typeof x?x:"function"===typeof x?x(b):"object"===typeof x&&String(x).startsWith("rgb")?x:x[b]});l&&v.selectAll(".values").remove().exit().data(a).enter().append("text").attr("class","values").attr("fill",m).attr("text-anchor",
"middle").attr("x",function(a){return k(a[e])+k.bandwidth()/2}).attr("y",function(a){return u(a[b])-10}).text(function(a){return h(a[b])})};w(n)})};p.update=function(a){w(a);return p};p.width=function(b){if(!arguments.length)return a;a=b;return p};p.height=function(a){if(!arguments.length)return d;d=a;return p};p.xSelector=function(a){if(!arguments.length)return e;e=a;return p};p.ySelector=function(a){if(!arguments.length)return b;b=a;return p};p.scaleX=function(a){if(!arguments.length)return k;k=
a;return p};p.scaleY=function(a){if(!arguments.length)return u;u=a;return p};p.fill=function(a){if(!arguments.length)return x;x=a;return p};p.yExtent=function(a){if(!arguments.length)return q;q=a;return p};p.valuesShow=function(a){if(!arguments.length)return l;l=a;return p};p.valuesFill=function(a){if(!arguments.length)return m;m=a;return p};p.valueFormat=function(a){if(!arguments.length)return h;h=a;return p};p.padding=function(a){if(!arguments.length)return c;c=a;return p};p.widthFactor=function(a){if(!arguments.length)return f;
f=a;return p};p.sortDirection=function(a){if(!arguments.length)return t;if("desc"!=a&&"asc"!=a)throw Error("Only desc or asc are allowed as sort order.");t=a;return p};p.sortBy=function(a){if(!arguments.length)return g;g=a;return p};return p},wbChordDiagram=function(){var a=500,d="black",c=d3.scaleOrdinal(d3.schemeCategory20c),f,e,b=function(b){b.each(function(b,k,g){b=d3.select(g[k]);var t=a/2-100,l=d3.chord().padAngle(.04).sortSubgroups(d3.descending).sortChords(d3.descending);k=d3.arc().innerRadius(t).outerRadius(t+
20);g=d3.ribbon().radius(t);l=l(f);b.attr("class","chord-circle").datum(l);b.append("circle").attr("fill","none").attr("pointer-events","all").attr("r",t+20);l=b.selectAll("group").data(function(a){return a.groups}).enter().append("g").style("fill-opacity",".8").on("mouseover",function(a,b){m.classed("fade",function(a){return a.source.index!=b&&a.target.index!=b})}).on("mousemove",function(){}).on("mouseout",function(){});l.append("path").style("stroke",d).style("fill",d).attr("d",k);l.append("text").each(function(a){a.angle=
...
function(a,b){return c(b)}).attr("d",g.radius(t))})};b.radius=function(c){if(!arguments.length)return a;a=c;return b};b.matrix=function(a){if(!arguments.length)return f;f=a;return b};b.keys=function(a){if(!arguments.length)return e;e=a;return b};b.colors=function(a){if(!arguments.length)return c;c=a;return b};b.fill=function(a){if(!arguments.length)return d;d=a;return b};return b},wbDonutChart=function(){var a=500,d="black",c=d3.scaleOrdinal(d3.schemeCategory10),f=function(e){e.each(function(b,e,
...
function wbGeoMap(){var a=500,d=500,c="#666666",f="#555555",e=1,b,k,u=!0,q=function(){},g=function(g){g.each(function(g,m,h){var l=d3.select(h[m]),t,p=function(b){var c=a/2,g=d/2,h=1;null===t||t!==b?(g=A.centroid(b),c=+g[0],g=+g[1],h=2.5,t=b):t=null;l.transition().duration(1E3).attr("transform","translate("+a/2+","+d/2+")scale("+h+")translate("+-c+","+-g+")").style("stroke-width",1.75/h+"px")};h=d3.geoBounds(g);b&&(h=b);m=h[0];h=h[1];var n=-(h[0]+m[0])/2,v=[(h[0]+m[0])/2+n,(h[1]+m[1])/2];k=d3.geoAlbers().parallels([m[1],
h[1]]).translate([a/2,d/2]).rotate([n,0,0]).center(v);var y=k(m),C=k(h);y=1*Math.min(a/(C[0]-y[0]),d/(-C[1]+y[1]));k=d3.geoAlbers().parallels([m[1],h[1]]).rotate([n,0,0]).translate([a/2,d/2]).scale(975*y).center(v);var A=d3.geoPath().projection(k);q=function(){l.selectAll(".wb-feature-paths").exit().remove().data(g.features).enter().append("path").attr("d",A).attr("class","wb-feature-paths").style("fill",c).style("stroke",f).style("stroke-width",e);if(u)l.selectAll(".wb-feature-paths").on("click",
p)};q()})};g.width=function(b){if(!arguments.length)return a;a=b;return g};g.height=function(a){if(!arguments.length)return d;d=a;return g};g.projection=function(a){if(!arguments.length)return k;k=a;return g};g.mapFill=function(a){if(!arguments.length)return c;c=a;return g};g.mapStroke=function(a){if(!arguments.length)return f;f=a;return g};g.boundsManual=function(a){if(!arguments.length)return b;b=a;return g};g.mapStrokeWidth=function(a){if(!arguments.length)return e;e=a;return g};g.allowZoom=function(a){if(!arguments.length)return u;
u=a;return g};g.update=function(){q()};return g}
function wbHeatMap(){var a=500,d=500,c="black",f="#ffffd9 #edf8b1 #c7e9b4 #7fcdbb #41b6c4 #1d91c0 #225ea8 #253494 #081d58".split(" "),e=function(b){b.each(function(b,e,q){e=d3.select(q[e]);b.forEach(function(a){a.day=+a.day;a.hour=+a.hour;a.value=+a.value});q=Array(24);for(var g=0;g<q.length;g++)q[g]=g+"";g="Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" ");var k=Math.floor(a/24),l=Math.floor(d/g.length);e.selectAll(".dayLabel").data(g).enter().append("text").text(function(a){return a}).attr("x",0).attr("y",
function(a,b){return b*l}).style("text-anchor","end").style("fill",c).attr("dominant-baseline","middle").attr("transform","translate(-6,"+l/2+")");e.selectAll(".timeLabel").data(q).enter().append("text").text(function(a){return a}).attr("x",function(a,b){return b*k}).attr("y",0).style("text-anchor","middle").style("fill",c).attr("transform","translate("+k/2+", -6)");q=e.selectAll(".hour").data(b).enter().append("rect").attr("x",function(a){return a.hour*k}).attr("y",function(a){return(a.day-1)*l}).attr("class",
"hour bordered").attr("width",k).attr("height",l).attr("stroke",c).attr("stroke-width","1").style("fill",c);b=d3.extent(b,function(a){return a.value});var m=d3.scaleQuantile().domain(b).range(f);q.style("fill",function(a){return m(a.value)});b=e.selectAll(".legend").data([0].concat(m.quantiles()),function(a){return a}).enter().append("g");b.append("rect").attr("x",function(a,b){return 2*k*b}).attr("y",d+10).attr("width",2*k).attr("height",l/2).attr("stroke",c).attr("stroke-width","1").style("fill",
...
function wbLinePlot(){var a=500,d=500,c=d3.scaleLinear(),f=d3.scaleLinear(),e="x",b=["y"],k=function(a){return a},u=function(a){return a},q,g,t,l,m=!1,h=["red"],x=1,w="white",p=[d3.curveBasis],n="black",v=0,y=0,C="red",A=!1,B=function(){},r=function(z){z.each(function(z,u,r){var w=d3.select(r[u]);if(2*b.length!=p.length+h.length)throw Error("If you enter more than one y-data-point, you need to set the curve and stroke options with equally-sized arrays.");u=w.append("g").attr("font-size","75%").attr("text-anchor",
"end").attr("transform","translate("+v+","+y+")").selectAll("g").data(b).enter().append("g").attr("transform",function(a,b){return"translate(0,"+20*b+")"});u.append("rect").attr("x",-19).attr("width",19).attr("height",19).attr("fill",function(a,b){return h[b]});u.append("text").attr("x",-22).attr("y",9.5).attr("dy","0.32em").text(function(a){return a}).attr("fill",n);if(A){w.append("line").attr("class","tooltip-line");w.append("text").attr("class","tooltip-text").attr("x",5).attr("y",0).style("font-size",
"85%").attr("text-anchor","start").attr("dominant-baseline","hanging").style("fill",n);b.forEach(function(a,b){w.append("circle").attr("class","tooltip-circle tooltip-circle-"+a)});var D=w.append("rect").attr("class","selector-box").attr("width",a).attr("height",d).attr("opacity",0)}B=function(z){void 0===t&&(t=d3.extent(z,function(a){return a[e]}));void 0===l&&(l=d3.extent(z.map(function(a){return b.map(function(b){return+a[b]})}).reduce(function(a,b){return a.concat(b)})),m&&(l[0]=0));q=c.rangeRound([0,
a]).domain(t);g=f.rangeRound([d,0]).domain(l);b.forEach(function(a,c){a=d3.line().curve(p[c]).x(function(a){return q(a[e])}).y(function(a){return g(a[b[c]])});var d="line-"+b[c];w.select("."+d).empty()?w.datum(z).append("path").attr("class","line "+d).attr("d",a).style("fill","none").style("stroke-linecap","round").style("stroke-linejoin","round").style("pointer-events","none").style("stroke-width",x).style("stroke",h[c]):w.datum(z).select("."+d).transition().duration(500).attr("d",a)})};B(z);u=function(){w.selectAll(".tooltip-line").attr("stroke",
"none");w.selectAll(".tooltip-circle").style("opacity",0);w.selectAll(".tooltip-text").style("opacity",0)};if(A)D.on("mousemove",function(){var a=[],c=d3.mouse(w.node()),f=d3.bisector(function(a){return a[e]}).right,l=q.invert(c[0]);c=f(z,l);var m=z[c-1];a.push(k(m[e]));var v=z[c];w.selectAll(".tooltip-line").attr("stroke","red").attr("x1",q(l)).attr("x2",q(l)).attr("y1",0).attr("y2",d);b.forEach(function(c,z){var d=d3.interpolateNumber(m[b[z]],v[b[z]]),f=v[e]-m[e];d=d(l%f/f);a.push(c+" \u2013 "+
m[b[z]]);w.select(".tooltip-circle-"+c).attr("cx",q(l)).attr("cy",g(d)).attr("r",7).style("fill",h[z]).style("opacity",1)});c=w.selectAll(".tooltip-text").style("opacity",1);w.selectAll(".tooltip-text-line").remove();for(f={i$1:0};f.i$1<a.length;f={i$1:f.i$1},f.i$1++)c.append("tspan").attr("class","tooltip-text-line").attr("x",5).attr("dy",function(a){return function(){return 0==a.i$1?0:15}}(f)).text(a[f.i$1])}).on("mouseout",u)})};r.width=function(b){if(!arguments.length)return a;a=b;return r};r.height=
function(a){if(!arguments.length)return d;d=a;return r};r.xAxisScale=function(a){if(!arguments.length)return c;c=a;return r};r.yAxisScale=function(a){if(!arguments.length)return f;f=a;return r};r.xDataPoints=function(a){if(!arguments.length)return e;e=a;return r};r.yDataPoints=function(a){if(!arguments.length)return b;b=a.constructor===Array?a:[a];return r};r.axisColor=function(a){if(!arguments.length)return w;w=a;return r};r.stroke=function(a){if(!arguments.length)return h;h=a.constructor===Array?
a:[a];return r};r.curve=function(a){if(!arguments.length)return p;p=a.constructor===Array?a:[a];return r};r.scaleX=function(){return q};r.scaleY=function(){return g};r.update=function(a){B(a);return r};r.xMinMax=function(a){if(!arguments.length)return t;t=a;return r};r.yMinMax=function(a){if(!arguments.length)return l;l=a;return r};r.legendFill=function(a){if(!arguments.length)return n;n=a;return r};r.legendX=function(a){if(!arguments.length)return v;v=a;return r};r.legendY=function(a){if(!arguments.length)return y;
y=a;return r};r.strokeWidth=function(a){if(!arguments.length)return x;x=a;return r};r.setYMinToZero=function(a){if(!arguments.length)return m;m=a;return r};r.dataPointLineFill=function(a){if(!arguments.length)return C;C=a;return r};r.xDataPointsFormat=function(a){if(!arguments.length)return k;k=a;return r};r.yDataPointsFormat=function(a){if(!arguments.length)return u;u=a;return r};r.activateTooltip=function(a){if(!arguments.length)return A;console.log("ATTENTION: This feature is experimental.");A=
a;return r};return r}
function wbNetworkDiagram(){var a=500,d=500,c="black",f="black",e=1,b="black",k=[1,10],u=[5,20],q,g=0,t=0,l=.5,m=["red","green","blue"],h=function(h){h.each(function(h,x,n){x=d3.select(n[x]);var v=d3.scaleLinear().domain(d3.extent(h.nodes,function(a){return a.weight})).range(u),p=d3.scaleLinear().domain(d3.extent(h.links,function(a){return a.value})).range(k);h.nodes.forEach(function(a){a.r=v(a.weight)});var w=x.append("g").selectAll("line").data(h.links).enter().append("line").attr("class","lines").attr("stroke-width",
function(a){return p(a.value)}).style("stroke",c).style("stroke-opacity","0.6"),A=x.append("g").selectAll("circle").data(h.nodes).enter().append("circle").attr("class","circles").attr("r",function(a){return a.r}).attr("fill",function(a){return m[a.group]}).style("stroke",f).style("stroke-width",e).call(d3.drag().on("start",function(a){d3.event.active||B.alphaTarget(.5).restart();a.fx=a.x;a.fy=a.y}).on("drag",function(a){a.fx=d3.event.x;a.fy=d3.event.y}).on("end",function(a){d3.event.active||B.alphaTarget(0);
a.fx=null;a.fy=null})),B=d3.forceSimulation().force("x",d3.forceX(a)).force("y",d3.forceY(d)).force("center",d3.forceCenter(a/2,d/2)).force("charge",d3.forceManyBody()).force("collide",d3.forceCollide().radius(function(a){return a.r+l}).iterations(3)).force("link",d3.forceLink().id(function(a){return a.id}));B.nodes(h.nodes).on("tick",function(){A.attr("cx",function(b){return b.x=Math.max(b.r,Math.min(a-b.r,b.x))}).attr("cy",function(a){return a.y=Math.max(a.r,Math.min(d-a.r,a.y))});w.attr("x1",function(a){return a.source.x}).attr("y1",
function(a){return a.source.y}).attr("x2",function(a){return a.target.x}).attr("y2",function(a){return a.target.y})});B.force("link").links(h.links);if(void 0===q){var r=[];h.nodes.forEach(function(a){r.push(a.group)});h=Array.from(new Set(r.sort()));q=[];for(n=0;n<h.length;n++)q.push([h[n],m(h[n])])}h=x.append("g").attr("font-size","75%").attr("text-anchor","end").selectAll("g").data(q).enter().append("g").attr("transform",function(a,b){return"translate(0,"+(20*b+10)+")"});h.append("rect").attr("x",
a-19+g).attr("y",0+t).attr("width",19).attr("height",19).attr("fill",function(a){return a[1]});h.append("text").attr("x",a-24+g).attr("y",9.5+t).attr("dy","0.32em").attr("fill",b).text(function(a){return a[0]})})};h.legendShiftX=function(a){if(!arguments.length)return g;g=a;return h};h.legendShiftY=function(a){if(!arguments.length)return t;t=a;return h};h.width=function(b){if(!arguments.length)return a;a=b;return h};h.height=function(a){if(!arguments.length)return d;d=a;return h};h.linkStroke=function(a){if(!arguments.length)return c;
c=a;return h};h.nodeStroke=function(a){if(!arguments.length)return f;f=a;return h};h.nodeStrokeWidth=function(a){if(!arguments.length)return e;e=a;return h};h.legend=function(a){if(!arguments.length)return q;q=a;return h};h.legendColor=function(a){if(!arguments.length)return b;b=a;return h};h.colors=function(a){if(!arguments.length)return m;m=a;return h};h.collide=function(a){if(!arguments.length)return l;l=a;return h};h.thicknessRange=function(a){if(!arguments.length)return k;k=a;return h};h.radiusRange=
function(a){if(!arguments.length)return u;u=a;return h};return h}
function wbNumericHistogram(){var a=500,d=500,c="red",f="white",e=50,b=function(){},k=function(k){k.each(function(k,g,u){function l(g){p.domain(g);var l=d3.histogram().value(function(a){return a.value}).domain(p.domain()).thresholds(p.ticks(e))(k);g=d3.extent(l,function(a){return a.length});v.domain(g);z.selectAll(".bar").remove().exit().data(l).enter().append("rect").attr("class","bar").attr("fill",c).attr("width",function(b,c){b=a/l.length;return b-.1*b}).attr("height",function(a){return d-v(a.length)}).attr("y",
function(a){return v(a.length)}).transition(n).attr("x",function(a){return p(a.x0)});h.select(".axis-x").transition(n).call(y);h.select(".axis-y").transition(n).call(C);h.selectAll(".axis line").attr("stroke",f);h.selectAll(".axis path").attr("stroke",f);h.selectAll(".axis text").attr("fill",f);b()}function m(){B=null}var h=d3.select(u[g]),t,q=d3.extent(k,function(a){return a.value}),p=d3.scaleLinear().rangeRound([0,a]),n=h.transition().duration(750),v=d3.scaleLinear().rangeRound([d,0]),y=d3.axisBottom(p),
C=d3.axisLeft(v),A=d3.brushX().extent([[0,0],[a,d]]).on("end",function(){var a=d3.event.selection;if(a)t=[p.invert(a[0])<q[0]?q[0]:p.invert(a[0]),p.invert(a[1])>q[1]?q[1]:p.invert(a[1])],h.select(".brush").call(A.move,null);else{if(!B)return B=setTimeout(m,r);t=q}l(t)}),B=null,r=350;h.append("g").attr("class","brush").call(A);var z=h.append("g");h.append("g").attr("transform","translate(0,"+d+")").attr("class","axis axis-x");h.append("g").attr("class","axis axis-y");l(q)})};k.height=function(a){if(!arguments.length)return d;
...
function wbPackedBubbles(){var a=500,d=500,c=["green","white"],f=["green","red"],e,b=function(b){b.each(function(b,k,g){k=d3.select(g[k]);g=d3.extent(b,function(a){return a.value});var t=d3.scaleLinear().domain(g).interpolate(d3.interpolate).range(c),l=d3.scaleLinear().domain(g).interpolate(d3.interpolate).range(f),m;e&&(m=d3.scaleLog().domain(g).range(e));g=d3.pack().size([a,d]).padding(.3);b=d3.hierarchy({children:b}).sum(function(a){return a.value});b=k.selectAll("node").data(g(b).leaves()).enter().append("g").attr("class",
...
function wbScatterPlot(){var a=500,d=500,c=d3.scaleLinear(),f=d3.scaleLinear(),e=d3.scaleLinear(),b="green",k="red",u="x",q="y",g="x",t="white",l=function(){},m=void 0,h=[0,1],x=function(a){return a},w=function(a){return a},p=function(){},n=function(v){v.each(function(v,n,A){var y=d3.select(A[n]),r=d3.extent(v,function(a){return a[u]}),z=d3.extent(v,function(a){return a[q]}),D=d3.extent(v,function(a){return a[g]});y.selectAll(".datapoint").data(v).enter().append("a").attr("xlink:href",l).append("rect").attr("class",
"datapoint").attr("width",8).attr("height",8).attr("rx",5);y.append("g").attr("class","axis axis-x").attr("transform","translate(0,"+d+")");y.append("g").attr("class","axis axis-y");var C,E,H,I,F,G;p=function(l){l=l||!1;void 0!==m&&(I=d3.scaleLog().domain(d3.extent(v,function(a){return a[m]})).range(h));C=c.range([0,a]).domain(r);E=f.range([d,0]).domain(z);H=e.domain(D).interpolate(d3.interpolate).range([b,k]);G=d3.axisLeft(E);w(G);F=d3.axisBottom(C);x(F);y.select(".axis-x").transition().duration(500).call(F);
y.select(".axis-y").transition().duration(500).call(G);y.selectAll(".axis line").attr("stroke",t);y.selectAll(".axis path").attr("stroke",t);y.selectAll(".axis text").attr("fill",t);(l?y.selectAll(".datapoint"):y.selectAll(".datapoint").transition().duration(500)).attr("opacity",function(a){return void 0!==m?I(a[m]):1}).attr("x",function(a){return C(a[u])-4}).attr("y",function(a){return E(a[q])-4}).style("fill",function(a){return H(a[g])})};p(!0)})};n.width=function(b){if(!arguments.length)return a;
a=b;return n};n.height=function(a){if(!arguments.length)return d;d=a;return n};n.xAxisScale=function(a){if(!arguments.length)return c;c=a;return n};n.yAxisScale=function(a){if(!arguments.length)return f;f=a;return n};n.zAxisScale=function(a){if(!arguments.length)return e;e=a;return n};n.xDataPoints=function(a){if(!arguments.length)return u;u=a;return n};n.yDataPoints=function(a){if(!arguments.length)return q;q=a;return n};n.zDataPoints=function(a){if(!arguments.length)return g;g=a;return n};n.opacityDataPoints=
function(a){if(!arguments.length)return m;m=a;return n};n.opacityRange=function(a){if(!arguments.length)return h;h=a;return n};n.axisColor=function(a){if(!arguments.length)return t;t=a;return n};n.colorLow=function(a){if(!arguments.length)return b;b=a;return n};n.colorHigh=function(a){if(!arguments.length)return k;k=a;return n};n.href=function(a){if(!arguments.length)return l;l=a;return n};n.formatXAxis=function(a){if(!arguments.length)return x;x=a;return n};n.formatYAxis=function(a){if(!arguments.length)return w;
w=a;return n};n.update=function(){p();return n};return n}
function wbStackedBarChart(){var a=500,d=500,c="x",f="y",e=["red","green","blue"],b="black",k=0,u=0,q=[],g,t,l=!1,m=function(c){c.each(function(c,h,f){h=d3.select(f[h]);c.forEach(function(a,b){var c=Object.keys(a);for(b=a.total=0;b<c.length;++b)q.includes(c[b])||"id"==c[b]||(a.total+=+a[c[b]])});l&&c.sort(function(a,b){return b.total-a.total});g=d3.scaleBand().rangeRound([0,a]).paddingInner(.05).align(.1);t=d3.scaleLinear().rangeRound([d,0]);var m=d3.scaleOrdinal().range(e);g.domain(c.map(function(a){return a.id}));
t.domain([0,d3.max(c,function(a){return a.total})]).nice();f=c.columns.filter(function(a){return"id"!=a&&!q.includes(a)});m.domain(f);c=d3.stack().keys(f)(c);c.forEach(function(a){a.forEach(function(b){b.keyRef=a.key})});h.append("g").selectAll("g").data(c).enter().append("g").attr("fill",function(a){return m(a.key)}).selectAll("rect").data(function(a,b){return a}).enter().append("rect").attr("class","rects").attr("x",function(a){return g(a.data.id)}).attr("y",function(a){return t(a[1])}).attr("height",
function(a){return t(a[0])-t(a[1])}).attr("width",g.bandwidth());c=h.append("g").attr("font-size","75%").attr("text-anchor","end").attr("transform","translate("+k+","+u+")").selectAll("g").data(f.slice()).enter().append("g").attr("transform",function(a,b){return"translate(0,"+20*b+")"});c.append("rect").attr("x",-19).attr("width",19).attr("height",19).attr("fill",m);c.append("text").attr("x",-22).attr("y",9.5).attr("dy","0.32em").text(function(a){return a}).attr("fill",b)})};m.width=function(b){if(!arguments.length)return a;
a=b;return m};m.height=function(a){if(!arguments.length)return d;d=a;return m};m.xSelector=function(a){if(!arguments.length)return c;c=a;return m};m.ySelector=function(a){if(!arguments.length)return f;f=a;return m};m.scaleX=function(a){if(!arguments.length)return g;g=a;return m};m.scaleY=function(a){if(!arguments.length)return t;t=a;return m};m.colors=function(a){if(!arguments.length)return e;e=a;return m};m.legendFill=function(a){if(!arguments.length)return b;b=a;return m};m.legendX=function(a){if(!arguments.length)return k;
k=a;return m};m.legendY=function(a){if(!arguments.length)return u;u=a;return m};m.sortBySum=function(a){if(!arguments.length)return l;l=a;return m};m.ignoreColumns=function(a){if(!arguments.length)return q;q=a;return m};return m}
function wbStaticNumbers(){var a=500,d=500,c="black",f="red",e=function(b){b.each(function(b,e,q){e=d3.select(q[e]);var g=a/b.length,k=.1*a/(b.length-1);e.selectAll("number-value").data(b).enter().append("text").text(function(a){return a.name}).attr("x",function(a,b){return b*g}).attr("y",d).attr("text-anchor","left").attr("dominant-baseline","baseline").attr("fill",c).style("font-size","20px").style("font-weight","bold").text(function(a){return a.value}).style("font-size",function(a,b,c){a=c[b].getComputedTextLength();
...
function wbTimeseries(){var a=500,d=500,c="hour",f="red",e="orange",b="black",k=void 0,u=d3.mean,q,g,t,l=function(m){m.each(function(h,m,l){m=d3.select(l[m]);var p=d3.extent(h,function(a){return a.date});h.forEach(function(a){a.month=a.date.getMonth();a.year=a.date.getFullYear();a.weekday=a.date.getDay();a.hour=a.date.getHours();a.minute=a.date.getMinutes();a.day=(new Date(a.date)).setHours(0,0,0,0);a["minute-of-day"]=(new Date(a.date)).setSeconds(0,0)});l=d3.extent(h,function(a){return a[c]});if("month"==
c){var n=d3.timeMonths(new Date(2017,0,1),new Date(2017,11,31));var v=d3.timeFormat("%B")}else if("year"==c){n=d3.timeYears(new Date(l[0],0,1),new Date(l[1],12,1));v=function(a){return a};var w=[];n.forEach(function(a){w.push(a.getFullYear())});n=w}else"weekday"==c?(n=[0,1,2,3,4,5,6],v=d3.timeFormat("%A")):"day"==c?(n=d3.timeDays(p[0],p[1]),v=d3.timeFormat("%d.%m.%Y")):"minute-of-day"==c&&(n=d3.timeMinutes(p[0]-6E4,p[1]),v=d3.timeFormat("%H:%M"));q=d3.scaleOrdinal().domain(n).range(d3.range(0,a,a/
n.length));var x=a/n.length*.1;h=d3.histogram().value(function(a){return a[c]}).thresholds(n)(h);l=d3.max(h,function(a){return a.length});g=d3.scaleLinear().range([d,0]).domain([0,l+1]);l=d3.extent(h,function(a){return a.length});var A=a/n.length-x;m.selectAll("rect").data(h).enter().append("rect").attr("class","rects").attr("x",0).attr("fill",function(a){return f}).attr("transform",function(a){return"translate("+q(a.x0)+","+g(a.length)+")"}).attr("width",function(a){return A}).attr("height",function(a){return d-
g(a.length)});if(k){h.forEach(function(a){var b=[];a.forEach(function(a){b=b.concat(a.value)});a.mean=u(b)});var B=d3.scaleOrdinal().domain(n).range(d3.range(0,a,a/n.length)),r=a/n.length*.8;l=d3.max(h,function(a){return a.mean});t=d3.scaleLinear().range([d,0]).domain([0,l+1]);m.selectAll(".dim").data(h).enter().append("rect").attr("class","valuerects").attr("fill",function(a){return e}).attr("transform",function(b){var c=A/2-a/n.length*.1;return"translate("+(B(b.x0)+c)+","+t(b.mean)+")"}).attr("width",
function(b){return a/n.length-r}).attr("height",function(a){return d-t(a.mean)})}m=m.append("g").attr("transform","translate(0,"+d+")").selectAll("xaxis").data(h).enter();m.append("line").attr("x1",0).attr("x2",a).style("stroke",b);m.append("text").text(function(a,b){if("weekday"!=c)return v(n[b]);a=d3.timeDays(new Date(2017,0,1),new Date(2017,0,8));return v(a[n[b]])}).style("text-anchor","middle").style("font-size","70%").style("fill",b).attr("x",function(b,c){return a/n.length*c+a/n.length/2-x/
2}).attr("y",function(a,b,c){return c[b].getBBox().height+5});m.append("line").attr("x1",function(b,c){return a/n.length*c+a/n.length/2-x/2}).attr("x2",function(b,c){return a/n.length*c+a/n.length/2-x/2}).attr("y1",0).attr("y2",5).style("stroke",b)})};l.width=function(b){if(!arguments.length)return a;a=b;return l};l.height=function(a){if(!arguments.length)return d;d=a;return l};l.target=function(a){if(!arguments.length)return c;c=a;return l};l.fill=function(a){if(!arguments.length)return f;f=a;return l};
l.fillValues=function(a){if(!arguments.length)return e;e=a;return l};l.fillAxis=function(a){if(!arguments.length)return b;b=a;return l};l.scaleX=function(a){if(!arguments.length)return q;q=a;return l};l.scaleY=function(a){if(!arguments.length)return g;g=a;return l};l.scaleY2=function(a){if(!arguments.length)return t;t=a;return l};l.valueColumn=function(a){if(!arguments.length)return k;k=a;return l};l.valueColumnAggregation=function(a){if(!arguments.length)return u;u=a;return l};return l}
function wbTreeMap(){var a=500,d=500,c=d3.scaleOrdinal(d3.schemeCategory20c),f="black",e=function(b){b.each(function(b,e,q){e=d3.select(q[e]);q=d3.treemap().tile(d3.treemapResquarify).size([a,d]).round(!0).paddingInner(1.5);b=d3.hierarchy(b).eachBefore(function(a){a.data.id=(a.parent?a.parent.data.id+".":"")+a.data.name}).sum(function(a){return a.size}).sort(function(a,b){return b.height-a.height||b.value-a.value});q(b);b=e.selectAll("g").data(b.leaves()).enter().append("g").attr("class","cells").attr("transform",
