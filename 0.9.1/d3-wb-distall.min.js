...
!function(t){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=t();else if("function"==typeof define&&define.amd)define([],t);else{var n;(n=(n=(n="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).d3||(n.d3={})).layout||(n.layout={})).cloud=t()}}(function(){return function t(n,e,r){function o(a,u){if(!e[a]){if(!n[a]){var f="function"==typeof require&&require;if(!u&&f)return f(a,!0);if(i)return i(a,!0);var l=new Error("Cannot find module '"+a+"'");throw l.code="MODULE_NOT_FOUND",l}var c=e[a]={exports:{}};n[a][0].call(c.exports,function(t){var e=n[a][1][t];return o(e||t)},c,c.exports,t,n,e,r)}return e[a].exports}for(var i="function"==typeof require&&require,a=0;a<r.length;a++)o(r[a]);return o}({1:[function(t,n,e){function r(t){return t.text}function o(){return"serif"}function i(){return"normal"}function a(t){return Math.sqrt(t.value)}function u(){return 30*(~~(6*Math.random())-3)}function f(){return 1}function l(t,n,e,r){if(!n.sprite){var o=t.context,i=t.ratio;o.clearRect(0,0,(x<<5)/i,p/i);var a=0,u=0,f=0,l=e.length;for(--r;++r<l;){n=e[r],o.save(),o.font=n.style+" "+n.weight+" "+~~((n.size+1)/i)+"px "+n.font;var c=o.measureText(n.text+"m").width*i,s=n.size<<1;if(n.rotate){var h=Math.sin(n.rotate*d),y=Math.cos(n.rotate*d),v=c*y,g=c*h,w=s*y,m=s*h;c=Math.max(Math.abs(v+m),Math.abs(v-m))+31>>5<<5,s=~~Math.max(Math.abs(g+w),Math.abs(g-w))}else c=c+31>>5<<5;if(s>f&&(f=s),a+c>=x<<5&&(a=0,u+=f,f=0),u+s>=p)break;o.translate((a+(c>>1))/i,(u+(s>>1))/i),n.rotate&&o.rotate(n.rotate*d),o.fillText(n.text,0,0),n.padding&&(o.lineWidth=2*n.padding,o.strokeText(n.text,0,0)),o.restore(),n.width=c,n.height=s,n.xoff=a,n.yoff=u,n.x1=c>>1,n.y1=s>>1,n.x0=-n.x1,n.y0=-n.y1,n.hasText=!0,a+=c}for(var M=o.getImageData(0,0,(x<<5)/i,p/i).data,b=[];--r>=0;)if((n=e[r]).hasText){for(var k=(c=n.width)>>5,s=n.y1-n.y0,_=0;_<s*k;_++)b[_]=0;if(null==(a=n.xoff))return;u=n.yoff;for(var q=0,E=-1,O=0;O<s;O++){for(_=0;_<c;_++){var z=k*O+(_>>5),I=M[(u+O)*(x<<5)+(a+_)<<2]?1<<31-_%32:0;b[z]|=I,q|=I}q?E=O:(n.y0++,s--,O--,u++)}n.y1=n.y0+E,n.sprite=b.slice(0,(n.y1-n.y0)*k)}}}function c(t){var n=t[0]/t[1];return function(t){return[n*(t*=.1)*Math.cos(t),t*Math.sin(t)]}}function s(){return document.createElement("canvas")}function h(t){return"function"==typeof t?t:function(){return t}}var y=t("d3-dispatch").dispatch,d=Math.PI/180,x=64,p=2048;n.exports=function(){var t=[256,256],n=r,e=o,d=a,g=i,w=i,m=u,M=f,b=c,k=[],_=1/0,q=y("word","end"),E=null,O=Math.random,z={},I=s;return z.canvas=function(t){return arguments.length?(I=h(t),z):I},z.start=function(){function r(){for(var n=Date.now();Date.now()-n<_&&++f<u&&E;){var e=s[f];e.x=t[0]*(O()+.5)>>1,e.y=t[1]*(O()+.5)>>1,l(o,e,s,f),e.hasText&&function(n,e,r){t[0],t[1];for(var o,i,a,u=e.x,f=e.y,l=Math.sqrt(t[0]*t[0]+t[1]*t[1]),c=b(t),s=O()<.5?1:-1,h=-s;(o=c(h+=s))&&(i=~~o[0],a=~~o[1],!(Math.min(Math.abs(i),Math.abs(a))>=l));)if(e.x=u+i,e.y=f+a,!(e.x+e.x0<0||e.y+e.y0<0||e.x+e.x1>t[0]||e.y+e.y1>t[1])&&(!r||!function(t,n,e){e>>=5;for(var r,o=t.sprite,i=t.width>>5,a=t.x-(i<<4),u=127&a,f=32-u,l=t.y1-t.y0,c=(t.y+t.y0)*e+(a>>5),s=0;s<l;s++){r=0;for(var h=0;h<=i;h++)if((r<<f|(h<i?(r=o[s*i+h])>>>u:0))&n[c+h])return!0;c+=e}return!1}(e,n,t[0]))&&(!r||function(t,n){return t.x+t.x1>n[0].x&&t.x+t.x0<n[1].x&&t.y+t.y1>n[0].y&&t.y+t.y0<n[1].y}(e,r))){for(var y,d=e.sprite,x=e.width>>5,p=t[0]>>5,v=e.x-(x<<4),g=127&v,w=32-g,m=e.y1-e.y0,M=(e.y+e.y0)*p+(v>>5),k=0;k<m;k++){y=0;for(var _=0;_<=x;_++)n[M+_]|=y<<w|(_<x?(y=d[k*x+_])>>>g:0);M+=p}return delete e.sprite,!0}return!1}(i,e,a)&&(c.push(e),q.call("word",z,e),a?function(t,n){var e=t[0],r=t[1];n.x+n.x0<e.x&&(e.x=n.x+n.x0),n.y+n.y0<e.y&&(e.y=n.y+n.y0),n.x+n.x1>r.x&&(r.x=n.x+n.x1),n.y+n.y1>r.y&&(r.y=n.y+n.y1)}(a,e):a=[{x:e.x+e.x0,y:e.y+e.y0},{x:e.x+e.x1,y:e.y+e.y1}],e.x-=t[0]>>1,e.y-=t[1]>>1)}f>=u&&(z.stop(),q.call("end",z,c,a))}var o=function(t){t.width=t.height=1;var n=Math.sqrt(t.getContext("2d").getImageData(0,0,1,1).data.length>>2);t.width=(x<<5)/n,t.height=p/n;var e=t.getContext("2d");return e.fillStyle=e.strokeStyle="red",e.textAlign="center",{context:e,ratio:n}}(I()),i=function(t){for(var n=[],e=-1;++e<t;)n[e]=0;return n}((t[0]>>5)*t[1]),a=null,u=k.length,f=-1,c=[],s=k.map(function(t,r){return t.text=n.call(this,t,r),t.font=e.call(this,t,r),t.style=g.call(this,t,r),t.weight=w.call(this,t,r),t.rotate=m.call(this,t,r),t.size=~~d.call(this,t,r),t.padding=M.call(this,t,r),t}).sort(function(t,n){return n.size-t.size});return E&&clearInterval(E),E=setInterval(r,0),r(),z},z.stop=function(){return E&&(clearInterval(E),E=null),z},z.timeInterval=function(t){return arguments.length?(_=null==t?1/0:t,z):_},z.words=function(t){return arguments.length?(k=t,z):k},z.size=function(n){return arguments.length?(t=[+n[0],+n[1]],z):t},z.font=function(t){return arguments.length?(e=h(t),z):e},z.fontStyle=function(t){return arguments.length?(g=h(t),z):g},z.fontWeight=function(t){return arguments.length?(w=h(t),z):w},z.rotate=function(t){return arguments.length?(m=h(t),z):m},z.text=function(t){return arguments.length?(n=h(t),z):n},z.spiral=function(t){return arguments.length?(b=v[t]||t,z):b},z.fontSize=function(t){return arguments.length?(d=h(t),z):d},z.padding=function(t){return arguments.length?(M=h(t),z):M},z.random=function(t){return arguments.length?(O=t,z):O},z.on=function(){var t=q.on.apply(q,arguments);return t===q?z:t},z};var v={archimedean:c,rectangular:function(t){var n=4*t[0]/t[1],e=0,r=0;return function(t){var o=t<0?-1:1;switch(Math.sqrt(1+4*o*t)-o&3){case 0:e+=n;break;case 1:r+=4;break;case 2:e-=n;break;default:r-=4}return[e,r]}}}},{"d3-dispatch":2}],2:[function(t,n,e){!function(t,r){r("object"==typeof e&&void 0!==n?e:t.d3=t.d3||{})}(this,function(t){"use strict";function n(){for(var t,n=0,r=arguments.length,o={};n<r;++n){if(!(t=arguments[n]+"")||t in o)throw new Error("illegal type: "+t);o[t]=[]}return new e(o)}function e(t){this._=t}function r(t,n,e){for(var r=0,i=t.length;r<i;++r)if(t[r].name===n){t[r]=o,t=t.slice(0,r).concat(t.slice(r+1));break}return null!=e&&t.push({name:n,value:e}),t}var o={value:function(){}};e.prototype=n.prototype={constructor:e,on:function(t,n){var e,o=this._,i=function(t,n){return t.trim().split(/^|\s+/).map(function(t){var e="",r=t.indexOf(".");if(r>=0&&(e=t.slice(r+1),t=t.slice(0,r)),t&&!n.hasOwnProperty(t))throw new Error("unknown type: "+t);return{type:t,name:e}})}(t+"",o),a=-1,u=i.length;{if(!(arguments.length<2)){if(null!=n&&"function"!=typeof n)throw new Error("invalid callback: "+n);for(;++a<u;)if(e=(t=i[a]).type)o[e]=r(o[e],t.name,n);else if(null==n)for(e in o)o[e]=r(o[e],t.name,null);return this}for(;++a<u;)if((e=(t=i[a]).type)&&(e=function(t,n){for(var e,r=0,o=t.length;r<o;++r)if((e=t[r]).name===n)return e.value}(o[e],t.name)))return e}},copy:function(){var t={},n=this._;for(var r in n)t[r]=n[r].slice();return new e(t)},call:function(t,n){if((e=arguments.length-2)>0)for(var e,r,o=new Array(e),i=0;i<e;++i)o[i]=arguments[i+2];if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(i=0,e=(r=this._[t]).length;i<e;++i)r[i].value.apply(n,o)},apply:function(t,n,e){if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(var r=this._[t],o=0,i=r.length;o<i;++o)r[o].value.apply(n,e)}},t.dispatch=n,Object.defineProperty(t,"__esModule",{value:!0})})},{}]},{},[1])(1)});
...
$jscomp.polyfill=function(c,d,e,h){if(d){e=$jscomp.global;c=c.split(".");for(h=0;h<c.length-1;h++){var g=c[h];g in e||(e[g]={});e=e[g]}c=c[c.length-1];h=e[c];d=d(h);d!=h&&null!=d&&$jscomp.defineProperty(e,c,{configurable:!0,writable:!0,value:d})}};
$jscomp.polyfill("String.prototype.startsWith",function(c){return c?c:function(c,e){var d=$jscomp.checkStringArgs(this,c,"startsWith");c+="";var g=d.length,m=c.length;e=Math.max(0,Math.min(e|0,d.length));for(var l=0;l<m&&e<g;)if(d[e++]!=c[l++])return!1;return l>=m}},"es6","es3");
(function(c,d){if(void 0===c.d3)throw Error("d3 required but not loaded.");"object"===typeof exports&&"undefined"!==typeof module?d(exports):"function"===typeof define&&define.amd?define(["exports"],d):d(c.d3wb=c.d3wb||{})})(this,function(c){d3wb.symbol={mean:"\u00d8",median:"x\u0303",sum:"\u03a3"};d3wb.config=function(){return{width:n("Width"),height:n("Height"),margin:{top:0,right:0,bottom:0,left:0},parentDivId:null,svgId:null,debug:!1,bgColor:f(),datasrc:void 0,attr:function(a,b){if(void 0!==a&&
void 0!==b)return a=String(a).trim(),"string"===typeof b&&(b=String(b).trim()),a.match(/^margin\..+$/)?(a=a.split("."),this[a[0]][a[1]]=+b):"margin"==a&&String(b).match(/^[0-9]+[ ]+[0-9]+[ ]+[0-9]+[ ]+[0-9]+$/)?(b=b.split(/[ ]+/),this.margin={top:+b[0],right:+b[1],bottom:+b[2],left:+b[3]}):this[a]=b,this},data:function(a){if(!arguments.length)return this.datasrc;this.datasrc=a;return this},toCanvas:function(){return d(this)}}};var d=function(a){e(a);k(a.parentDivId)||a.parentDivId.startsWith("#")||
(a.parentDivId="#"+a.parentDivId);k(a.svgId)||a.svgId.startsWith("#")||(a.svgId="#"+a.svgId);p(a);a.innerWidth=a.width-a.margin.left-a.margin.right;a.innerHeight=a.height-a.margin.top-a.margin.bottom;var b=k(a.svgId)||null==d3.select(a.svgId).node()?d3.select("svg"):d3.select(a.svgId);b.attr("width",a.width).attr("height",a.height);b.append("rect").attr("width",a.width).attr("height",a.height).attr("fill",a.bgColor);d3.select("#standalone-body").style("background-color",a.bgColor);m(b,a);l(b,a);var c=
b.append("g").attr("transform","translate("+a.margin.left+","+a.margin.top+")");c.svg=b;c.width=a.innerWidth;c.wid=a.innerWidth;c.w=a.innerWidth;c.height=a.innerHeight;c.hei=a.innerHeight;c.h=a.innerHeight;c.margin=a.margin;c.mar=a.margin;c.m=a.margin;c.data=a.data();c.d=a.data();c.div=d3.select(a.parentDivId?a.parentDivId:"#standalone-body");c.transformCircular=function(){this.attr("transform","translate("+(this.w/2+this.m.left)+","+(this.h/2+this.m.top)+")")};return c},e=function(a){var b=document.getElementsByTagName("script");
if(!k(b)&&0!=b.length){var c=b[b.length-1].src.split("/");if(!(k(c)||2>c.length)){c=c[c.length-2];b=b[b.length-1];var d=b.getAttribute("embedded")||!1;a.debug&&(console.log("scri-path | "+c),console.log("embedded  | "+d));if(d){a.svgId=b.getAttribute("svgid")||!1;a.parentDivId=b.getAttribute("divid")||!1;c=b.getAttribute("datapath")||void 0;if(void 0!==a.datasrc)if("string"===typeof a.datasrc||a.datasrc instanceof String)h(a.datasrc)||(a.datasrc=c+"/"+a.datasrc);else for(b=0;b<a.datasrc.length;b++)h(a.datasrc[b])||
(a.datasrc[b]=c+"/"+a.datasrc[b]);a.debug&&(console.log("svg-id    | "+a.svgId),console.log("parent-id | "+a.parentDivId),console.log("data-path | "+c),console.log("res-path  | "+a.datasrc))}}}},h=function(a){return void 0===a?!1:a.match(/^(https?).*/)?!0:!1},g=d3.format(".1f"),m=function(a,b){b.debug&&(a.append("rect").attr("width",b.width).attr("height",b.height).attr("fill",f("lightgrey")),a.append("text").attr("x",b.width).attr("fill",f()).style("dominant-baseline","hanging").style("text-anchor",
"end").style("-moz-user-select","none").style("user-select","none").text(g(b.width)+"x"+g(b.height)),a.append("rect").attr("width",b.margin.left).attr("height",b.margin.top).attr("fill",f("verylightgrey")),a.append("text").attr("font-size","80%").attr("x",b.margin.left/2).attr("fill",f()).style("dominant-baseline","hanging").style("text-anchor","middle").style("-moz-user-select","none").style("user-select","none").text(g(b.margin.left)),a.append("text").attr("font-size","80%").attr("y",b.margin.top/
2).attr("fill",f()).style("dominant-baseline","middle").style("text-anchor","begin").style("-moz-user-select","none").style("user-select","none").text(g(b.margin.top)),a.append("rect").attr("x",b.width-b.margin.right).attr("y",b.height-b.margin.bottom).attr("width",b.margin.right).attr("height",b.margin.bottom).attr("fill",f("verylightgrey")),a.append("text").attr("font-size","80%").attr("x",b.width-b.margin.right/2).attr("y",b.height).attr("fill",f()).style("dominant-baseline","baseline").style("text-anchor",
"middle").style("-moz-user-select","none").style("user-select","none").text(g(b.margin.right)),a.append("text").attr("font-size","80%").attr("x",b.width).attr("y",b.height-b.margin.bottom/2).attr("fill",f()).style("dominant-baseline","middle").style("text-anchor","end").style("-moz-user-select","none").style("user-select","none").text(g(b.margin.bottom)))},l=function(a,b){b.debug&&(a=a.append("g"),a.append("rect").attr("width",b.innerWidth).attr("height",b.innerHeight).attr("fill",f("grey")),a.append("text").attr("x",
b.innerWidth).attr("fill",f()).style("dominant-baseline","hanging").style("text-anchor","end").style("-moz-user-select","none").style("user-select","none").text(g(b.innerWidth)+"x"+g(b.innerHeight)),a.append("circle").attr("cx",b.innerWidth/2).attr("cy",b.innerHeight/2).attr("r",5).attr("fill",f()),a.append("line").attr("x1",0).attr("x2",b.innerWidth/2).attr("y1",0).attr("y2",b.innerHeight/2).attr("stroke-width",1).attr("stroke",f()),a.append("line").attr("x1",b.innerWidth).attr("x2",b.innerWidth/
2).attr("y1",b.innerHeight).attr("y2",b.innerHeight/2).attr("stroke-width",1).attr("stroke",f()),a.append("line").attr("x1",b.innerWidth).attr("x2",b.innerWidth/2).attr("y1",0).attr("y2",b.innerHeight/2).attr("stroke-width",1).attr("stroke",f()),a.append("line").attr("x1",0).attr("x2",b.innerWidth/2).attr("y1",b.innerHeight).attr("y2",b.innerHeight/2).attr("stroke-width",1).attr("stroke",f()),a.attr("transform","translate("+b.margin.left+","+b.margin.top+")"))},p=function(a){if(!k(a.parentDivId)&&
null!=d3.select(a.parentDivId).node()){var b=d3.select(a.parentDivId).node().getBoundingClientRect(),c=b.width;1>c&&(c=a.width);b=b.height;a.width=c;a.height=b}},k=function(a){return"undefined"===typeof a||null===a||""===a},n=function(a){return Math.max(document.documentElement["client"+a],document.body["scroll"+a],document.documentElement["scroll"+a],document.body["offset"+a],document.documentElement["offset"+a])},f=function(a){var b=void 0!==d3wb.theme;switch(a){case "grey":return b?d3wb.color.background.fade(30):
"rgb(192, 192, 192)";case "lightgrey":return b?d3wb.color.background.fade(20):"rgb(162, 162, 162)";case "verylightgrey":return b?d3wb.color.background.fade(10):"rgb(132, 132, 132)";default:return b?d3wb.color.background:"rgb(255, 255, 255)"}};return d3wb});
...
$jscomp.polyfill=function(a,g,c,b){if(g){c=$jscomp.global;a=a.split(".");for(b=0;b<a.length-1;b++){var f=a[b];f in c||(c[f]={});c=c[f]}a=a[a.length-1];b=c[a];g=g(b);g!=b&&null!=g&&$jscomp.defineProperty(c,a,{configurable:!0,writable:!0,value:g})}};$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};
...
$jscomp.arrayIterator=function(a){var g=0;return $jscomp.iteratorPrototype(function(){return g<a.length?{done:!1,value:a[g++]}:{done:!0}})};$jscomp.iteratorPrototype=function(a){$jscomp.initSymbolIterator();a={next:a};a[$jscomp.global.Symbol.iterator]=function(){return this};return a};
$jscomp.iteratorFromArray=function(a,g){$jscomp.initSymbolIterator();a instanceof String&&(a+="");var c=0,b={next:function(){if(c<a.length){var f=c++;return{value:g(f,a[f]),done:!1}}b.next=function(){return{done:!0,value:void 0}};return b.next()}};b[Symbol.iterator]=function(){return b};return b};$jscomp.polyfill("Array.prototype.entries",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a,c){return[a,c]})}},"es6","es3");
$jscomp.polyfill("Object.is",function(a){return a?a:function(a,c){return a===c?0!==a||1/a===1/c:a!==a&&c!==c}},"es6","es3");$jscomp.polyfill("Array.prototype.includes",function(a){return a?a:function(a,c){var b=this;b instanceof String&&(b=String(b));var f=b.length;for(c=c||0;c<f;c++)if(b[c]==a||Object.is(b[c],a))return!0;return!1}},"es7","es3");
...
$jscomp.polyfill("Array.prototype.values",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a,c){return c})}},"es6","es3");$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6","es3");
$jscomp.polyfill("String.prototype.startsWith",function(a){return a?a:function(a,c){var b=$jscomp.checkStringArgs(this,a,"startsWith");a+="";var f=b.length,e=a.length;c=Math.max(0,Math.min(c|0,b.length));for(var k=0;k<e&&c<f;)if(b[c++]!=a[k++])return!1;return k>=e}},"es6","es3");
(function(a,g){if(void 0===a.d3wb)throw Error("d3wb required but not loaded.");"object"===typeof exports&&"undefined"!==typeof module?g(exports):"function"===typeof define&&define.amd?define(["exports"],g):g(a.d3wb.util=a.d3wb.util||{})})(this,function(a){var g=function(){return c()+c()+"-"+c()+"-"+c()+"-"+c()+"-"+c()+c()+c()};d3wb.util={setLocale:function(b){if("de"==b)d3.timeFormat=d3.timeFormatLocale({dateTime:"%A, der %e. %B %Y, %X",date:"%d.%m.%Y",time:"%H:%M:%S",periods:["AM","PM"],days:"Sonntag Montag Dienstag Mittwoch Donnerstag Freitag Samstag".split(" "),
shortDays:"So Mo Di Mi Do Fr Sa".split(" "),months:"Januar Februar M\u00e4rz April Mai Juni Juli August September Oktober November Dezember".split(" "),shortMonths:"Jan Feb Mrz Apr Mai Jun Jul Aug Sep Okt Nov Dez".split(" ")}).format;else throw Error("Unsupported locale.");},changeCSVSeparator:function(b){d3.csv=function(a,e){d3.request(a).mimeType("text/csv").response(function(a){return d3.dsvFormat(b).parse(a.responseText)}).get(e)}},smoothData:function(b,a,e,k){var f=[],d=[];b.forEach(function(a,
h){h+=1;f.push(a[e]);if(0==h%k||h==b.length)a=d3.median(f),d.push(a),f=[]});var l=[],p=0,c=0,h;for(h in d)if(Object.prototype.hasOwnProperty.call(d,h)){p+=k;for(var g=p>b.length?b.length%k:k,u=d3.interpolate(0==h?b[0][e]:d[h-1],d[h]),w=1/g,v=0,r=0;r<g;r++){v+=w;var t={};t[a]=b[c][a];t[e]=u(v);l.push(t);c+=1}}return l},countCsvColumn:function(a,f,e,k){e=void 0===e?!0:e;a=d3.nest().key(function(a){return a[f]}).entries(a);void 0!==k&&0<k.length&&(a=a.filter(function(a){return!k.includes(a.key)}));for(var b=
[],d=0;d<a.length;d++)b.push({label:a[d].key,count:+a[d].values.length});var c=d3.sum(b,function(a){return+a.count});b.forEach(function(a){a.percent=+a.count/c*100});e&&b.sort(function(a,b){return b.percent-a.percent});return b},guid:g,websafeGuid:function(){return"d3wb-"+g()},injectCSS:function(a){var b=document.getElementsByTagName("head")[0],e=document.createElement("style");e.styleSheet?e.styleSheet.cssText=a:e.appendChild(document.createTextNode(a));b.appendChild(e)},logSVGSize:function(a){a=
a.ownerSVGElement.getBBox();console.log(a.x+" x "+a.y+" | "+a.width+" x "+a.height)},jsonAttributeMapToCSV:function(a){var b=["key"],e=a[Object.keys(a)[0]];for(n in e)Object.prototype.hasOwnProperty.call(e,n)&&b.push(n);e=['"'+b.join('","')+'"'];for(var c in a)if(Object.prototype.hasOwnProperty.call(a,c)){var n=[c];for(var d in b)0!=d&&n.push(a[c][b[d]]);e.push('"'+n.join('","')+'"')}a=e.join("\n");return d3.csvParse(a)},getBoundingBoxCenter:function(a){a=d3.select(a).node().getBBox();return[a.x+
a.width/2,a.y+a.height/2]}};var c=function(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}});
(function(a,g){"object"===typeof exports&&"undefined"!==typeof module?g(exports):"function"===typeof define&&define.amd?define(["exports"],g):g(a.d3wb.theme=a.d3wb.theme||{})})(this,function(a){var g="light",c={dark:{background:"#1D1F21",black:"#282A2E",blue:"#5F819D",cyan:"#5E8D87",foreground:"#C5C8C6",green:"#8C9440",magenta:"#85678F",red:"#A54242",white:"#707880",yellow:"#DE935F"},eqie6:{background:"#111111",black:"#222222",blue:"#66A9B9",cyan:"#6D878D",foreground:"#CCCCCC",green:"#B7CE42",magenta:"#B7416E",
red:"#E84F4F",white:"#CCCCCC",yellow:"#FEA63C"},gotham:{background:"#0A0F14",black:"#0A0F14",blue:"#195465",cyan:"#33859D",foreground:"#98D1CE",green:"#26A98B",magenta:"#4E5165",red:"#C33027",white:"#98D1CE",yellow:"#EDB54B"},light:{background:"#FFFFFF",black:"#000000",blue:"#87AFDF",cyan:"#AFDFDF",foreground:"#1A1D1D",green:"#AFD787",magenta:"#DFAFDF",red:"#D78787",white:"#FFFFFF",yellow:"#FFFFAF"},monokai:{background:"#272822",black:"#272822",blue:"#66D9EF",cyan:"#A1EFE4",foreground:"#F8F8F2",green:"#A6E22E",
magenta:"#AE81FF",red:"#F92672",white:"#F8F8F2",yellow:"#F4BF75"},ocean:{background:"#2B303B",black:"#2B303B",blue:"#8FA1B3",cyan:"#96B5B4",foreground:"#C0C5CE",green:"#A3BE8C",magenta:"#B48EAD",red:"#BF616A",white:"#C0C5CE",yellow:"#EBCB8B"},sweetlove:{background:"#1F1F1F",black:"#4A3637",blue:"#535C5C",cyan:"#6D715E",foreground:"#C0B18B",green:"#7B8748",magenta:"#775759",red:"#D17B49",white:"#C0B18B",yellow:"#AF865A"},tomorrowlight:{background:"#FFFFFF",black:"#1D1F21",blue:"#81A2BE",cyan:"#8ABEB7",
foreground:"#373B41",green:"#B5BD68",magenta:"#B294BB",red:"#CC6666",white:"#C5C8C6",yellow:"#F0C674"},yousay:{background:"#F5E7DE",black:"#666661",blue:"#4C7399",cyan:"#D97742",foreground:"#34302D",green:"#4C3226",magenta:"#BF9986",red:"#992E2E",white:"#34302D",yellow:"#A67C53"}},b=function(a){for(var d=[],b=0;b<a.length;b++)a[b].startsWith("#")?d.push(""+d3.rgb(a[b])):d.push(""+d3wb.color(a[b]));return d},f=function(){for(var a=["blue","red","green","magenta","foreground"],d=[],b=0;b<a.length;b++){var e=
d3wb.color.lohiScaleArray(a[b],5,[.6,.6]);d=d.concat(e)}return d},e=function(){for(var a="blue cyan green magenta red yellow foreground".split(" "),d=[],b=0;b<a.length;b++)d.push(q(a[b]));return d},k=function(a,b,d,e){a=q(a);b=q(b);a=d3.interpolateRgb(a,b);e=e||[0,1];if(2>=d)a=[a(0),a(1)];else{d=(e[1]-e[0])/d;b=e[0]+d;var c=[];c.push(a(e[0]));do c.push(a(b)),b+=d;while(b<e[1]-d-.0001);c.push(a(e[1]));a=c}return a},n=function(a,b,d){d=d||[.4,.7];var e=0==b%2;b=e?b/2:(b+1)/2;e=k("black",a,e?b+1:b,[d[0],
1]);a=k(a,"white",b,[0,d[1]]);return e.concat(a.slice(1))},d=function(){return d3.scaleOrdinal(d3wb.color.category())},l=function(){for(var a=[],b=2;25>b;b+=5)a.push(d3wb.color.category()[b]);return d3.scaleOrdinal(a)},p=function(a,b){b=b||[d3wb.color.white,d3wb.color.black];return d3.scaleLinear().domain(a).interpolate(d3.interpolate).range(b)},m=function(a,b){return d3.scaleQuantile().domain(a).range(b)},h=function(a,b){a.name=b;a.fade=function(b){return n(a.name,100)[b]};return a},q=function(a){var b=
a;"string"!==typeof a||a.startsWith("rgb")||(a=d3.rgb(d3wb.color[a]),a=h(a,b));return a};d3wb.theme=function(a){if(!arguments.length){var q=Object.keys(d3wb.color),u=[];for(r in q)"function"!==typeof d3wb.color[q[r]]&&u.push(d3wb.color[q[r]].name);return u}g=a;var r=c[a];var t={lohiScaleArray:n,array:b,gradientArray:k,category:f,categoryMain:e,quantile:m,linearGradient:p,ordinal:d,smallOrdinal:l};for(q in r)Object.prototype.hasOwnProperty.call(r,q)&&(t[q]=d3.rgb(r[q]),t[q]=h(t[q],q));d3wb.themes=
[];for(u in c)Object.prototype.hasOwnProperty.call(c,u)&&d3wb.themes.push(u);d3wb.color=t};d3wb.theme.add=function(a,b){c[a]=b;b=g;d3wb.theme(a);d3wb.theme(b)};d3wb.theme(g)});
(function(a,g){"object"===typeof exports&&"undefined"!==typeof module?g(exports):"function"===typeof define&&define.amd?define(["exports"],g):g(a.d3wb.mouse=a.d3wb.mouse||{})})(this,function(a){d3wb.mouse={tooltip:function(){var a=.8,c=5,b="white",f="black",e=20,k=5,n=function(){return(new Date).toDateString()+"\n"+String(Math.floor(9E8*Math.random()))},d=function(d){d.each(function(d,l,h){d=d3.select(h[l]);var q=h[l].ownerSVGElement,p=q.getBBox(),g=!1,m,r,t;d.on("mouseover",function(d){if(!g){g=
!0;m=d3.select(q).append("g").style("pointer-events","none").style("user-select","none").style("-moz-user-select","none");r=m.append("rect");t=m.append("text");d=(""+n(d)).split("\n");var h={};for(l in d)h.i$1=l,Object.prototype.hasOwnProperty.call(d,h.i$1)&&(t.append("tspan").style("text-anchor","middle").style("dominant-baseline","hanging").style("fill",b).attr("x",0).attr("dy",function(a){return function(){return 0==a.i$1?0:e}}(h)).text(d[h.i$1]),h={i$1:h.i$1});var l=t.node().getBBox();r.attr("rx",
k).attr("ry",k).attr("width",l.width+2*c).attr("height",l.height+2*c).attr("x",-(l.width/2)-c).attr("y",-c).attr("opacity",a).style("fill",f)}});d.on("mouseout",function(){g&&(g=!1,m.remove())});d.on("mousemove",function(){var a=d3.mouse(q),b=r.node().getBBox(),d=a[0];a=a[1]-b.height;d=0>d-b.width/2?b.width/2:d;d=d+b.width/2>p.width?p.width-b.width/2:d;a=0>a-c?c:a;a=a+b.height-c>p.height?p.height-b.height+c:a;m.attr("transform","translate("+d+","+a+")")})})};d.opacity=function(b){if(!arguments.length)return a;
a=b;return d};d.padding=function(a){if(!arguments.length)return c;c=a;return d};d.color=function(a){if(!arguments.length)return b;b=a;return d};d.fill=function(a){if(!arguments.length)return f;f=a;return d};d.lineHeight=function(a){if(!arguments.length)return e;e=a;return d};d.roundCorners=function(a){if(!arguments.length)return k;k=a;return d};d.selector=function(a){if(!arguments.length)return n;n=a;return d};return d},click:function(){var a=["dblclick"],c=["open"],b="dblclick",f="open",e=function(a,
b){return"https://d3js.org/"},k=function(a){a.each(function(a,d,e){a=d3.select(e[d]);n(f,b,a)})},n=function(a,b,c){if("open"==a)c.on(b,function(a,b){a=e(a,b);window.open(a,"_blank")})};k.event=function(d){if(!arguments.length)return b;if(!a.includes(d))throw Error("Event '"+d+"' not supported! Allowed: "+a);b=d;return k};k.action=function(a){if(!arguments.length)return f;if(!c.includes(a))throw Error("Action '"+a+"' not supported! Allowed: "+c);f=a;return k};k.openTarget=function(a){if(!arguments.length)return e;
e=a;return k};return k}}});
(function(a,g){if(void 0===a.d3wb.util)throw Error("d3wb.util required but not loaded.");"object"===typeof exports&&"undefined"!==typeof module?g(exports):"function"===typeof define&&define.amd?define(["exports"],g):g(a.d3wb.add=a.d3wb.add||{})})(this,function(a){var g=function(a){var e="red",c=d3.axisTop,f=0,d=void 0,l=function(k){k.each(function(k,h,n){b(e,"wb-axis-x");k=d3.select(n[h]).append("g").attr("transform","translate(0,"+f+")").attr("class","wb-axis wb-axis-x").call(c(a));90==d&&k.selectAll("text").attr("y",
-2).attr("x",-9).attr("dy",".35em").style("text-anchor","end").attr("transform","rotate(-90)")})};l.type=function(a){if(!arguments.length)return c;c=a;return l};l.y=function(a){if(!arguments.length)return f;f=a;return l};l.color=function(a){if(!arguments.length)return e;e=a;return l};l.rotation=function(a){if(!arguments.length)return d;d=a;return l};l.scale=function(b){if(!arguments.length)return a;a=b;return l};l.fontSize=function(a){d3wb.util.injectCSS("\n                .wb-axis-x text {\n                  font-size: "+
a+";\n              }");return l};return l},c=function(a){var e="red",c=d3.axisLeft,f=0,d=function(a){return a},l=function(){},g,m=function(h){h.each(function(h,k,n){b(e,"wb-axis-y");g=d3.select(n[k]).append("g").attr("class","wb-axis wb-axis-y").attr("transform","translate("+f+",0)");l=function(a){g.call(d(c(a)))};l(a)})};m.update=function(a){l(a);return m};m.format=function(a){if(!arguments.length)return d;d=a;return m};m.type=function(a){if(!arguments.length)return c;c=a;return m};m.x=function(a){if(!arguments.length)return f;
f=a;return m};m.color=function(a){if(!arguments.length)return e;e=a;return m};m.scale=function(b){if(!arguments.length)return a;a=b;return m};m.fontSize=function(a){d3wb.util.injectCSS("\n                .wb-axis-y text {\n                  font-size: "+a+";\n              }");return m};return m};d3wb.add={xAxis:g,xAxisBottom:function(a){return g(a).type(d3.axisBottom)},xAxisLabel:function(a){var b="red",c="top",f=function(d){d.each(function(d,e,f){d=d3.select(f[e].ownerSVGElement);var h=d.node().getBBox();
d.append("text").attr("transform",function(){var a="translate("+h.width/2+",";a="top"==c?a+15:a+(h.height-15);return a+")"}).style("text-anchor","middle").style("fill",b).attr("dominant-baseline",function(){return"top"==c?"hanging":"auto"}).text(a)})};f.color=function(a){if(!arguments.length)return b;b=a;return f};f.orientation=function(a){if(!arguments.length)return c;c=a;return f};return f},yAxis:c,yAxisRight:function(a){return c(a).type(d3.axisRight)},yAxisLabel:function(a){var b="red",c="left",
f=function(d){d.each(function(d,e,f){d=d3.select(f[e].ownerSVGElement);var h=d.node().getBBox();d.append("text").attr("transform",function(){var a="translate(";a="left"==c?a+5:a+(h.width-5);a+=","+h.height/2+") rotate(";a="left"==c?a+"-90":a+"90";return a+")"}).style("text-anchor","middle").attr("dominant-baseline","hanging").style("fill",b).text(a)})};f.color=function(a){if(!arguments.length)return b;b=a;return f};f.orientation=function(a){if(!arguments.length)return c;c=a;return f};return f},title:function(a){var b=
"red",c="140%",f=function(){},d=function(d){d.each(function(d,e,h){var g=d3.select(h[e].ownerSVGElement);d=g.node().getBBox();g.append("text").attr("class","wb-title").attr("x",d.width/2).attr("y",5).attr("text-anchor","middle").attr("dominant-baseline","hanging").style("pointer-events","none").style("fill",b).style("font-size",c);f=function(){g.selectAll(".wb-title").text(a)};f()})};d.color=function(a){if(!arguments.length)return b;b=a;return d};d.fontSize=function(a){if(!arguments.length)return c;
c=a;return d};d.text=function(b){if(!arguments.length)return a;a=b;return d};d.update=function(){f()};return d},shadow:function(){var a=d3wb.util.guid();return function(b){b.each(function(b,c,d){b=d3.select(d[c]);c=d3.select(d[c].ownerSVGElement).append("defs").append("filter").attr("id",a);c.append("feGaussianBlur").attr("in","SourceAlpha").attr("stdDeviation",3).attr("result","blur");c.append("feOffset").attr("in","blur").attr("dx",2).attr("dy",1).attr("result","offsetBlur");c.append("feComponentTransfer").append("feFuncA").attr("type",
"linear").attr("slope",.4);c=c.append("feMerge");c.append("feMergeNode").attr('in", "offsetBlur');c.append("feMergeNode").attr("in","SourceGraphic");b.style("filter","url(#"+a+")")})}},legend:function(){var a="white",b,c=["red","green","blue"],g=["Item 1","Item 2","Item 3"],d=0,l=0,p=d3.symbolCircle,m=100,h=function(e){e.each(function(e,f,h){e=d3.select(h[f]);e.append("g").attr("class","legend").attr("transform","translate("+d+","+l+")");f=d3.scaleOrdinal().domain(g.map(function(a){return a})).range(g.map(function(a,
b){return c[b]}));f=d3.legendColor().shape("path",d3.symbol().type(p).size(m)()).scale(f);e.select(".legend").call(f).style("fill",a).style("font-size","90%");b&&e.selectAll("path.swatch").style("stroke",b)})};h.stroke=function(a){if(!arguments.length)return b;b=a;return h};h.x=function(a){if(!arguments.length)return d;d=a;return h};h.y=function(a){if(!arguments.length)return l;l=a;return h};h.text=function(a){if(!arguments.length)return g;g=a;return h};h.colors=function(a){if(!arguments.length)return c;
c=a;return h};h.color=function(b){if(!arguments.length)return a;a=b;return h};h.symbol=function(a){if(!arguments.length)return p;p=a;return h};h.symbolSize=function(a){if(!arguments.length)return m;m=a;return h};return h}};var b=function(a,b){d3wb.util.injectCSS("\n            ."+b+" line{\n              stroke: "+a+";\n            }\n            ."+b+" path{\n              stroke: "+a+";\n            }\n            ."+b+" text{\n              fill: "+a+";\n            }\n            ")}});
(function(a,g){if(void 0===a.d3wb.util)throw Error("d3wb.util required but not loaded.");"object"===typeof exports&&"undefined"!==typeof module?g(exports):"function"===typeof define&&define.amd?define(["exports"],g):g(a.d3wb.html=a.d3wb.html||{})})(this,function(a){d3wb.html={dropdown:function(){var a=["Option 1","Option 2","Option 3"],f=function(b){b=g(b);b.each(function(b,d,c){b=function(){var b=d3.select("#"+e.id).property("value"),d=a.indexOf(b);e.callback(b,d)};d3.select(c[d]).append("select").attr("id",
e.id).on("change",b).selectAll("option").data(a).enter().append("option").text(function(a){return a});d3wb.util.injectCSS("\n                        #"+e.id+" {\n                            position: absolute;\n                        }\n                    ");b()})},e=c(f);f.options=function(b){if(!arguments.length)return a;a=b;return f};return f},button:function(){var a=["Click me"],f=0,e,k=function(b){b=g(b);b.each(function(b,d,c){b=function(){var b=d3.select("#"+n.id).text(),d=a.indexOf(b);f=
(f+1)%a.length;n.callback(b,d);e.text(a[f])};e=d3.select(c[d]).append("button").attr("id",n.id).style("user-select","none").style("-moz-user-select","none").text(a[f]).on("click",b);d3wb.util.injectCSS("\n                        #"+n.id+" {\n                            position: absolute;\n                        }\n                    ");n.callbackOnInit&&b()})},n=c(k);k.options=function(b){if(!arguments.length)return a;a=b;return k};return k},textfield:function(){var a=function(a){a=g(a);a.each(function(a,
b,d){d3.select(d[b]).append("input").attr("id",f.id).on("input",function(a,b,d){f.callback(d[b].value)});d3wb.util.injectCSS("\n                        #"+f.id+" {\n                            position: absolute;\n                        }\n                    ")})},f=c(a);return a},infoBox:function(){var a="white",f="yellow",e="white",k=e,n="black",d="\x3cb\x3eInformation\x3c/b\x3e\x3c/br\x3e\n        This box contains information about the graph. It's intended to guide the user. You can use \x3ci\x3ehtml-style\x3c/i\x3e as desired.\n        ",
l=!1,p=function(b){b=g(b);b.each(function(b,c,g){b=d3.select(g[c]).append("div").attr("id",m.id);c=b.append("p").attr("id",m.id+"-in").html("\x26#9432;");b.append("p").attr("id",m.id+"-ib").html(d);c.on("click",function(){l=!l;d3wb.util.injectCSS("#"+m.id+"-ib { opacity: "+(l?.9:0)+";}")});d3wb.util.injectCSS("\n                    #"+m.id+" {\n                        position: absolute;\n                        margin: 0;\n                        padding: 0;\n                        pointer-events:none;\n                    }\n                    #"+
m.id+"-in {\n                        position: relative;\n                        text-align: left;\n                        width: 0;\n                        -webkit-touch-callout: none;\n                        -webkit-user-select: none;\n                        -khtml-user-select: none;\n                        -moz-user-select: none;\n                        -ms-user-select: none;\n                        user-select: none;\n                        margin: 0;\n                        padding: 0;\n                        color: "+
a+";\n                        font-size: 150%;\n                        pointer-events: auto;\n                    }\n                    #"+m.id+"-in:hover {\n                        cursor: default;\n                        color: "+f+";\n                    }\n                    #"+m.id+"-ib {\n                        position: relative;\n                        text-align: left;\n                        -webkit-touch-callout: none;\n                        -webkit-user-select: none;\n                        -khtml-user-select: none;\n                        -moz-user-select: none;\n                        -ms-user-select: none;\n                        user-select: none;\n                        margin: 0;\n                        padding: 0.5em;\n                        border-radius: 0.4em;\n                        border: 1px solid "+
k+";\n                        color: "+e+";\n                        font-size: 100%;\n                        background-color: "+n+";\n                        opacity: 0;\n                    }\n                ")})},m=c(p);p.controlColor=function(b){if(!arguments.length)return a;a=b;return p};p.controlColorHover=function(a){if(!arguments.length)return f;f=a;return p};p.controlHover=function(a){if(!arguments.length)return controlHover;controlHover=a;return p};p.infoColor=function(a){if(!arguments.length)return e;
e=a;return p};p.infoFill=function(a){if(!arguments.length)return n;n=a;return p};p.infoContent=function(a){if(!arguments.length)return d;d=a;return p};return p}};var g=function(a){return void 0!==a.div?a.div:a},c=function(a){var b={id:d3wb.util.websafeGuid(),div:d3.select("body"),callback:function(){console.log("callback.")},callbackOnInit:!1};a.id=function(c){if(!arguments.length)return"#"+b.id;id=c;return a};a.style=function(c,f){d3wb.util.injectCSS("\n                        #"+b.id+" {\n                            "+
c+": "+f+";\n                        }\n                    ");return a};a.callback=function(c){if(!arguments.length)return b.callback;b.callback=c;return a};return b}});
...
$jscomp.polyfill("WeakMap",function(a){function d(a){$jscomp.owns(a,f)||$jscomp.defineProperty(a,f,{value:{}})}function c(a){var m=Object[a];m&&(Object[a]=function(a){d(a);return m(a)})}if(function(){if(!a||!Object.seal)return!1;try{var c=Object.seal({}),m=Object.seal({}),b=new a([[c,2],[m,3]]);if(2!=b.get(c)||3!=b.get(m))return!1;b.delete(c);b.set(m,4);return!b.has(c)&&4==b.get(m)}catch(g){return!1}}())return a;var f="$jscomp_hidden_"+Math.random().toString().substring(2);c("freeze");c("preventExtensions");
c("seal");var e=0,b=function(a){this.id_=(e+=Math.random()+1).toString();if(a){$jscomp.initSymbol();$jscomp.initSymbolIterator();a=$jscomp.makeIterator(a);for(var m;!(m=a.next()).done;)m=m.value,this.set(m[0],m[1])}};b.prototype.set=function(a,m){d(a);if(!$jscomp.owns(a,f))throw Error("WeakMap key fail: "+a);a[f][this.id_]=m;return this};b.prototype.get=function(a){return $jscomp.owns(a,f)?a[f][this.id_]:void 0};b.prototype.has=function(a){return $jscomp.owns(a,f)&&$jscomp.owns(a[f],this.id_)};b.prototype.delete=
...
$jscomp.polyfill("Map",function(a){if(!$jscomp.ASSUME_NO_NATIVE_MAP&&function(){if(!a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var m=Object.seal({x:4}),c=new a($jscomp.makeIterator([[m,"s"]]));if("s"!=c.get(m)||1!=c.size||c.get({x:4})||c.set({x:4},"t")!=c||2!=c.size)return!1;var g=c.entries(),b=g.next();if(b.done||b.value[0]!=m||"s"!=b.value[1])return!1;b=g.next();return b.done||4!=b.value[0].x||"t"!=b.value[1]||!g.next().done?!1:!0}catch(l){return!1}}())return a;$jscomp.initSymbol();
$jscomp.initSymbolIterator();var d=new WeakMap,c=function(a){this.data_={};this.head_=b();this.size=0;if(a){a=$jscomp.makeIterator(a);for(var c;!(c=a.next()).done;)c=c.value,this.set(c[0],c[1])}};c.prototype.set=function(a,c){var g=f(this,a);g.list||(g.list=this.data_[g.id]=[]);g.entry?g.entry.value=c:(g.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:a,value:c},g.list.push(g.entry),this.head_.previous.next=g.entry,this.head_.previous=g.entry,this.size++);return this};c.prototype.delete=
...
a.value]})};c.prototype.keys=function(){return e(this,function(a){return a.key})};c.prototype.values=function(){return e(this,function(a){return a.value})};c.prototype.forEach=function(a,c){for(var g=this.entries(),b;!(b=g.next()).done;)b=b.value,a.call(c,b[1],b[0],this)};c.prototype[Symbol.iterator]=c.prototype.entries;var f=function(a,c){var g=c&&typeof c;"object"==g||"function"==g?d.has(c)?g=d.get(c):(g=""+ ++k,d.set(c,g)):g="p_"+c;var b=a.data_[g];if(b&&$jscomp.owns(a.data_,g))for(a=0;a<b.length;a++){var f=
b[a];if(c!==c&&f.key!==f.key||c===f.key)return{id:g,list:b,index:a,entry:f}}return{id:g,list:b,index:-1,entry:void 0}},e=function(a,c){var g=a.head_;return $jscomp.iteratorPrototype(function(){if(g){for(;g.head!=a.head_;)g=g.previous;for(;g.next!=g.head;)return g=g.next,{done:!1,value:c(g)};g=null}return{done:!0,value:void 0}})},b=function(){var a={};return a.previous=a.next=a.head=a},k=0;return c},"es6","es3");
...
var wbBarChart=function(){var a=500,d=500,c=.1,f=1,e="x",b="y",k,m,r,g,u="desc",l,p="black",h=function(a){return a},x="blue",v=function(){},q=function(n){n.each(function(n,q,C){var w=d3.select(C[q]);k=d3.scaleBand().rangeRound([0,a],.1).padding(c);m=d3.scaleLinear().range([d,0]);v=function(a){a.forEach(function(a){a[b]=+a[b]});g&&a.sort(function(a,h){return"desc"==u?+h[g]-+a[g]:+a[g]-+h[g]});var c=r?r:[0,d3.max(a,function(a){return a[b]})];m.domain(c);k.domain(a.map(function(a){return a[e]}));w.selectAll(".rects").remove().exit().data(a).enter().append("rect").attr("class",
"rects").attr("x",function(a){if(1<=f)return k(a[e]);var h=k.bandwidth()-k.bandwidth()*f;return k(a[e])+h/2}).attr("width",function(a){return k.bandwidth()*f}).attr("y",function(a){return m(a[b])}).attr("height",function(a){return d-m(a[b])}).attr("fill",function(a,h){return"string"===typeof x?x:"function"===typeof x?x(h):"object"===typeof x&&String(x).startsWith("rgb")?x:x[h]});l&&w.selectAll(".values").remove().exit().data(a).enter().append("text").attr("class","values").attr("fill",p).attr("text-anchor",
"middle").attr("x",function(a){return k(a[e])+k.bandwidth()/2}).attr("y",function(a){return m(a[b])-10}).text(function(a){return h(a[b])})};v(n)})};q.update=function(a){v(a);return q};q.width=function(h){if(!arguments.length)return a;a=h;return q};q.height=function(a){if(!arguments.length)return d;d=a;return q};q.xSelector=function(a){if(!arguments.length)return e;e=a;return q};q.ySelector=function(a){if(!arguments.length)return b;b=a;return q};q.scaleX=function(a){if(!arguments.length)return k;k=
a;return q};q.scaleY=function(a){if(!arguments.length)return m;m=a;return q};q.fill=function(a){if(!arguments.length)return x;x=a;return q};q.yExtent=function(a){if(!arguments.length)return r;r=a;return q};q.valuesShow=function(a){if(!arguments.length)return l;l=a;return q};q.valuesFill=function(a){if(!arguments.length)return p;p=a;return q};q.valueFormat=function(a){if(!arguments.length)return h;h=a;return q};q.padding=function(a){if(!arguments.length)return c;c=a;return q};q.widthFactor=function(a){if(!arguments.length)return f;
f=a;return q};q.sortDirection=function(a){if(!arguments.length)return u;if("desc"!=a&&"asc"!=a)throw Error("Only desc or asc are allowed as sort order.");u=a;return q};q.sortBy=function(a){if(!arguments.length)return g;g=a;return q};return q},wbChordDiagram=function(){var a=500,d="black",c=d3.scaleOrdinal(d3.schemeCategory20c),f,e,b=function(b){b.each(function(b,k,g){b=d3.select(g[k]);var m=a/2-100,l=d3.chord().padAngle(.04).sortSubgroups(d3.descending).sortChords(d3.descending);k=d3.arc().innerRadius(m).outerRadius(m+
20);g=d3.ribbon().radius(m);l=l(f);b.attr("class","chord-circle").datum(l);b.append("circle").attr("fill","none").attr("pointer-events","all").attr("r",m+20);l=b.selectAll("group").data(function(a){return a.groups}).enter().append("g").style("fill-opacity",".8").on("mouseover",function(a,b){p.classed("fade",function(a){return a.source.index!=b&&a.target.index!=b})}).on("mousemove",function(){}).on("mouseout",function(){});l.append("path").style("stroke",d).style("fill",d).attr("d",k);l.append("text").each(function(a){a.angle=
(a.startAngle+a.endAngle)/2}).attr("dy",".35em").style("font-size","90%").attr("text-anchor",function(a){return a.angle>Math.PI?"end":null}).attr("transform",function(a){return"rotate("+(180*a.angle/Math.PI-90)+")translate("+(m+26)+")"+(a.angle>Math.PI?"rotate(180)":"")}).style("fill",d).text(function(a){return e[a.index].key});var p=b.selectAll("chord").data(function(a){return a}).enter().append("path").attr("class","chordpaths").style("fill-opacity",".8").style("stroke-width","25px").style("fill",
function(a,b){return c(b)}).attr("d",g.radius(m))})};b.radius=function(c){if(!arguments.length)return a;a=c;return b};b.matrix=function(a){if(!arguments.length)return f;f=a;return b};b.keys=function(a){if(!arguments.length)return e;e=a;return b};b.colors=function(a){if(!arguments.length)return c;c=a;return b};b.fill=function(a){if(!arguments.length)return d;d=a;return b};return b},wbDonutChart=function(){var a=500,d="black",c=d3.scaleOrdinal(d3.schemeCategory10),f=function(e){e.each(function(b,e,
f){e=d3.select(f[e]);f=d3.pie().value(function(a){return a.percent}).sort(null).padAngle(.03);var k=a/2,g=a/8;g=d3.arc().outerRadius(k).innerRadius(g);e.selectAll("path").data(f(b)).enter().append("path").attr("class","paths").attr("d",g).attr("fill",function(a,b){return c(b)});b=d3.scaleOrdinal().domain(b.map(function(a){return a.label})).range(b.map(function(a,b){return c(b)}));e.append("g").attr("class","legend").attr("transform",function(a,b){return"translate("+(k+10)+","+(-k+10)+")"});b=d3.legendColor().shape("path",
...
function wbGeoMap(){var a=500,d=500,c="#666666",f="#555555",e=1,b,k,m=!0,r=function(){},g=function(g){g.each(function(g,p,h){var l=d3.select(h[p]),u,q=function(b){var c=a/2,g=d/2,h=1;null===u||u!==b?(g=A.centroid(b),c=+g[0],g=+g[1],h=2.5,u=b):u=null;l.transition().duration(1E3).attr("transform","translate("+a/2+","+d/2+")scale("+h+")translate("+-c+","+-g+")").style("stroke-width",1.75/h+"px")};h=d3.geoBounds(g);b&&(h=b);p=h[0];h=h[1];var n=-(h[0]+p[0])/2,w=[(h[0]+p[0])/2+n,(h[1]+p[1])/2];k=d3.geoAlbers().parallels([p[1],
h[1]]).translate([a/2,d/2]).rotate([n,0,0]).center(w);var y=k(p),C=k(h);y=1*Math.min(a/(C[0]-y[0]),d/(-C[1]+y[1]));k=d3.geoAlbers().parallels([p[1],h[1]]).rotate([n,0,0]).translate([a/2,d/2]).scale(975*y).center(w);var A=d3.geoPath().projection(k);r=function(){l.selectAll(".wb-feature-paths").exit().remove().data(g.features).enter().append("path").attr("d",A).attr("class","wb-feature-paths").style("fill",c).style("stroke",f).style("stroke-width",e);if(m)l.selectAll(".wb-feature-paths").on("click",
q)};r()})};g.width=function(b){if(!arguments.length)return a;a=b;return g};g.height=function(a){if(!arguments.length)return d;d=a;return g};g.projection=function(a){if(!arguments.length)return k;k=a;return g};g.mapFill=function(a){if(!arguments.length)return c;c=a;return g};g.mapStroke=function(a){if(!arguments.length)return f;f=a;return g};g.boundsManual=function(a){if(!arguments.length)return b;b=a;return g};g.mapStrokeWidth=function(a){if(!arguments.length)return e;e=a;return g};g.allowZoom=function(a){if(!arguments.length)return m;
m=a;return g};g.update=function(){r()};return g}
function wbHeatMap(){var a=500,d=500,c="black",f="#ffffd9 #edf8b1 #c7e9b4 #7fcdbb #41b6c4 #1d91c0 #225ea8 #253494 #081d58".split(" "),e=function(b){b.each(function(b,e,r){e=d3.select(r[e]);b.forEach(function(a){a.day=+a.day;a.hour=+a.hour;a.value=+a.value});r=Array(24);for(var g=0;g<r.length;g++)r[g]=g+"";g="Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" ");var k=Math.floor(a/24),l=Math.floor(d/g.length);e.selectAll(".dayLabel").data(g).enter().append("text").text(function(a){return a}).attr("x",0).attr("y",
...
function wbLinePlot(){var a=500,d=500,c=d3.scaleLinear(),f=d3.scaleLinear(),e="x",b=["y"],k=function(a){return a},m=function(a){return a},r,g,u,l,p=!1,h=["red"],x=1,v="white",q=[d3.curveBasis],n="black",w=0,y=0,C="red",A=!1,B=function(){},t=function(z){z.each(function(z,m,t){var v=d3.select(t[m]);if(2*b.length!=q.length+h.length)throw Error("If you enter more than one y-data-point, you need to set the curve and stroke options with equally-sized arrays.");m=v.append("g").attr("font-size","75%").attr("text-anchor",
"end").attr("transform","translate("+w+","+y+")").selectAll("g").data(b).enter().append("g").attr("transform",function(a,b){return"translate(0,"+20*b+")"});m.append("rect").attr("x",-19).attr("width",19).attr("height",19).attr("fill",function(a,b){return h[b]});m.append("text").attr("x",-22).attr("y",9.5).attr("dy","0.32em").text(function(a){return a}).attr("fill",n);if(A){v.append("line").attr("class","tooltip-line");v.append("text").attr("class","tooltip-text").attr("x",5).attr("y",0).style("font-size",
"85%").attr("text-anchor","start").attr("dominant-baseline","hanging").style("fill",n);b.forEach(function(a,b){v.append("circle").attr("class","tooltip-circle tooltip-circle-"+a)});var D=v.append("rect").attr("class","selector-box").attr("width",a).attr("height",d).attr("opacity",0)}B=function(z){void 0===u&&(u=d3.extent(z,function(a){return a[e]}));void 0===l&&(l=d3.extent(z.map(function(a){return b.map(function(b){return+a[b]})}).reduce(function(a,b){return a.concat(b)})),p&&(l[0]=0));r=c.rangeRound([0,
a]).domain(u);g=f.rangeRound([d,0]).domain(l);b.forEach(function(a,c){a=d3.line().curve(q[c]).x(function(a){return r(a[e])}).y(function(a){return g(a[b[c]])});var d="line-"+b[c];v.select("."+d).empty()?v.datum(z).append("path").attr("class","line "+d).attr("d",a).style("fill","none").style("stroke-linecap","round").style("stroke-linejoin","round").style("pointer-events","none").style("stroke-width",x).style("stroke",h[c]):v.datum(z).select("."+d).transition().duration(500).attr("d",a)})};B(z);m=function(){v.selectAll(".tooltip-line").attr("stroke",
"none");v.selectAll(".tooltip-circle").style("opacity",0);v.selectAll(".tooltip-text").style("opacity",0)};if(A)D.on("mousemove",function(){var a=[],c=d3.mouse(v.node()),f=d3.bisector(function(a){return a[e]}).right,m=r.invert(c[0]);c=f(z,m);var l=z[c-1];a.push(k(l[e]));var p=z[c];v.selectAll(".tooltip-line").attr("stroke","red").attr("x1",r(m)).attr("x2",r(m)).attr("y1",0).attr("y2",d);b.forEach(function(c,z){var d=d3.interpolateNumber(l[b[z]],p[b[z]]),f=p[e]-l[e];d=d(m%f/f);a.push(c+" \u2013 "+
l[b[z]]);v.select(".tooltip-circle-"+c).attr("cx",r(m)).attr("cy",g(d)).attr("r",7).style("fill",h[z]).style("opacity",1)});c=v.selectAll(".tooltip-text").style("opacity",1);v.selectAll(".tooltip-text-line").remove();for(f={i$1:0};f.i$1<a.length;f={i$1:f.i$1},f.i$1++)c.append("tspan").attr("class","tooltip-text-line").attr("x",5).attr("dy",function(a){return function(){return 0==a.i$1?0:15}}(f)).text(a[f.i$1])}).on("mouseout",m)})};t.width=function(b){if(!arguments.length)return a;a=b;return t};t.height=
function(a){if(!arguments.length)return d;d=a;return t};t.xAxisScale=function(a){if(!arguments.length)return c;c=a;return t};t.yAxisScale=function(a){if(!arguments.length)return f;f=a;return t};t.xDataPoints=function(a){if(!arguments.length)return e;e=a;return t};t.yDataPoints=function(a){if(!arguments.length)return b;b=a.constructor===Array?a:[a];return t};t.axisColor=function(a){if(!arguments.length)return v;v=a;return t};t.stroke=function(a){if(!arguments.length)return h;h=a.constructor===Array?
a:[a];return t};t.curve=function(a){if(!arguments.length)return q;q=a.constructor===Array?a:[a];return t};t.scaleX=function(){return r};t.scaleY=function(){return g};t.update=function(a){B(a);return t};t.xMinMax=function(a){if(!arguments.length)return u;u=a;return t};t.yMinMax=function(a){if(!arguments.length)return l;l=a;return t};t.legendFill=function(a){if(!arguments.length)return n;n=a;return t};t.legendX=function(a){if(!arguments.length)return w;w=a;return t};t.legendY=function(a){if(!arguments.length)return y;
y=a;return t};t.strokeWidth=function(a){if(!arguments.length)return x;x=a;return t};t.setYMinToZero=function(a){if(!arguments.length)return p;p=a;return t};t.dataPointLineFill=function(a){if(!arguments.length)return C;C=a;return t};t.xDataPointsFormat=function(a){if(!arguments.length)return k;k=a;return t};t.yDataPointsFormat=function(a){if(!arguments.length)return m;m=a;return t};t.activateTooltip=function(a){if(!arguments.length)return A;console.log("ATTENTION: This feature is experimental.");A=
a;return t};return t}
function wbNetworkDiagram(){var a=500,d=500,c="black",f="black",e=1,b="black",k=[1,10],m=[5,20],r,g=0,u=0,l=.5,p=["red","green","blue"],h=function(h){h.each(function(h,x,n){x=d3.select(n[x]);var w=d3.scaleLinear().domain(d3.extent(h.nodes,function(a){return a.weight})).range(m),q=d3.scaleLinear().domain(d3.extent(h.links,function(a){return a.value})).range(k);h.nodes.forEach(function(a){a.r=w(a.weight)});var v=x.append("g").selectAll("line").data(h.links).enter().append("line").attr("class","lines").attr("stroke-width",
function(a){return q(a.value)}).style("stroke",c).style("stroke-opacity","0.6"),A=x.append("g").selectAll("circle").data(h.nodes).enter().append("circle").attr("class","circles").attr("r",function(a){return a.r}).attr("fill",function(a){return p[a.group]}).style("stroke",f).style("stroke-width",e).call(d3.drag().on("start",function(a){d3.event.active||B.alphaTarget(.5).restart();a.fx=a.x;a.fy=a.y}).on("drag",function(a){a.fx=d3.event.x;a.fy=d3.event.y}).on("end",function(a){d3.event.active||B.alphaTarget(0);
a.fx=null;a.fy=null})),B=d3.forceSimulation().force("x",d3.forceX(a)).force("y",d3.forceY(d)).force("center",d3.forceCenter(a/2,d/2)).force("charge",d3.forceManyBody()).force("collide",d3.forceCollide().radius(function(a){return a.r+l}).iterations(3)).force("link",d3.forceLink().id(function(a){return a.id}));B.nodes(h.nodes).on("tick",function(){A.attr("cx",function(b){return b.x=Math.max(b.r,Math.min(a-b.r,b.x))}).attr("cy",function(a){return a.y=Math.max(a.r,Math.min(d-a.r,a.y))});v.attr("x1",function(a){return a.source.x}).attr("y1",
function(a){return a.source.y}).attr("x2",function(a){return a.target.x}).attr("y2",function(a){return a.target.y})});B.force("link").links(h.links);if(void 0===r){var t=[];h.nodes.forEach(function(a){t.push(a.group)});h=Array.from(new Set(t.sort()));r=[];for(n=0;n<h.length;n++)r.push([h[n],p(h[n])])}h=x.append("g").attr("font-size","75%").attr("text-anchor","end").selectAll("g").data(r).enter().append("g").attr("transform",function(a,b){return"translate(0,"+(20*b+10)+")"});h.append("rect").attr("x",
a-19+g).attr("y",0+u).attr("width",19).attr("height",19).attr("fill",function(a){return a[1]});h.append("text").attr("x",a-24+g).attr("y",9.5+u).attr("dy","0.32em").attr("fill",b).text(function(a){return a[0]})})};h.legendShiftX=function(a){if(!arguments.length)return g;g=a;return h};h.legendShiftY=function(a){if(!arguments.length)return u;u=a;return h};h.width=function(b){if(!arguments.length)return a;a=b;return h};h.height=function(a){if(!arguments.length)return d;d=a;return h};h.linkStroke=function(a){if(!arguments.length)return c;
c=a;return h};h.nodeStroke=function(a){if(!arguments.length)return f;f=a;return h};h.nodeStrokeWidth=function(a){if(!arguments.length)return e;e=a;return h};h.legend=function(a){if(!arguments.length)return r;r=a;return h};h.legendColor=function(a){if(!arguments.length)return b;b=a;return h};h.colors=function(a){if(!arguments.length)return p;p=a;return h};h.collide=function(a){if(!arguments.length)return l;l=a;return h};h.thicknessRange=function(a){if(!arguments.length)return k;k=a;return h};h.radiusRange=
function(a){if(!arguments.length)return m;m=a;return h};return h}
function wbNumericHistogram(){var a=500,d=500,c="red",f="white",e=50,b=function(){},k=function(k){k.each(function(k,g,m){function l(g){q.domain(g);var m=d3.histogram().value(function(a){return a.value}).domain(q.domain()).thresholds(q.ticks(e))(k);g=d3.extent(m,function(a){return a.length});w.domain(g);z.selectAll(".bar").remove().exit().data(m).enter().append("rect").attr("class","bar").attr("fill",c).attr("width",function(b,c){b=a/m.length;return b-.1*b}).attr("height",function(a){return d-w(a.length)}).attr("y",
function(a){return w(a.length)}).transition(n).attr("x",function(a){return q(a.x0)});h.select(".axis-x").transition(n).call(y);h.select(".axis-y").transition(n).call(C);h.selectAll(".axis line").attr("stroke",f);h.selectAll(".axis path").attr("stroke",f);h.selectAll(".axis text").attr("fill",f);b()}function p(){B=null}var h=d3.select(m[g]),u,r=d3.extent(k,function(a){return a.value}),q=d3.scaleLinear().rangeRound([0,a]),n=h.transition().duration(750),w=d3.scaleLinear().rangeRound([d,0]),y=d3.axisBottom(q),
C=d3.axisLeft(w),A=d3.brushX().extent([[0,0],[a,d]]).on("end",function(){var a=d3.event.selection;if(a)u=[q.invert(a[0])<r[0]?r[0]:q.invert(a[0]),q.invert(a[1])>r[1]?r[1]:q.invert(a[1])],h.select(".brush").call(A.move,null);else{if(!B)return B=setTimeout(p,t);u=r}l(u)}),B=null,t=350;h.append("g").attr("class","brush").call(A);var z=h.append("g");h.append("g").attr("transform","translate(0,"+d+")").attr("class","axis axis-x");h.append("g").attr("class","axis axis-y");l(r)})};k.height=function(a){if(!arguments.length)return d;
...
function wbPackedBubbles(){var a=500,d=500,c=["green","white"],f=["green","red"],e,b,k=function(k){k.each(function(k,g,m){g=d3.select(m[g]);m=d3.extent(k,function(a){return a.value});var l=d3.scaleLinear().domain(m).interpolate(d3.interpolate).range(c),p=d3.scaleLinear().domain(m).interpolate(d3.interpolate).range(f);e&&(b=d3.scaleLog().domain(m).range(e));m=d3.pack().size([a,d]).padding(.3);k=d3.hierarchy({children:k}).sum(function(a){return a.value});k=g.selectAll("node").data(m(k).leaves()).enter().append("g").attr("class",
"node").attr("transform",function(a){return"translate("+a.x+","+a.y+")"});k.append("a").attr("xlink:href",function(a){return a.data.link}).append("circle").attr("class","circles").attr("id",function(a){return a.id}).transition().duration(500).attr("r",function(a){return a.r}).style("fill",function(a){return p(a.value)}).style("opacity",function(a){return e?b(a.value):"1.0"});k.append("a").attr("xlink:href",function(a){return a.data.link}).append("text").attr("class","texts").style("font-size","10px").style("text-anchor",
"middle").style("dominant-baseline","middle").style("cursor","default").style("user-select","none").style("-moz-user-select","none").attr("x",0).attr("y",0).text(function(a){return a.data.id}).style("font-size",function(a,b,c){return(2*a.r-10)/c[b].getComputedTextLength()*10+"px"}).style("opacity",function(a){return e?b(a.value):"1.0"}).transition().duration(1E3).style("fill",function(a){return l(a.value)})})};k.width=function(b){if(!arguments.length)return a;a=b;return k};k.height=function(a){if(!arguments.length)return d;
d=a;return k};k.colorRange=function(a){if(!arguments.length)return c;c=a;return k};k.fillRange=function(a){if(!arguments.length)return f;f=a;return k};k.fadeOpacity=function(a){if(!arguments.length)return e;e=a;return k};k.fadeScale=function(a){if(!arguments.length)return b;b=a;return k};return k}
function wbSankeyDiagram(){var a=500,d=500,c="black",f=d3.scaleOrdinal(d3.schemeCategory20c),e=function(b){b.each(function(b,e,r){e=d3.select(r[e]);d3.sankey().nodeWidth(15).nodePadding(10).size([a,d])(b);e.append("g").attr("class","sankey-link").style("fill","none").style("stroke",c).style("stroke-opacity",.2).selectAll("path").data(b.links).enter().append("path").attr("d",d3.sankeyLinkHorizontal()).attr("stroke-width",function(a){return Math.max(1,a.width)});b=e.append("g").attr("class","sankey-node").selectAll("g").data(b.nodes).enter().append("g");
b.append("rect").attr("x",function(a){return a.x0}).attr("y",function(a){return a.y0}).attr("height",function(a){return a.y1-a.y0}).attr("width",function(a){return a.x1-a.x0}).attr("fill",function(a){return f(a.name.replace(/ .*/,""))}).style("stroke",function(a){return c});b.append("text").style("fill",function(a){return c}).attr("x",function(a){return a.x0-6}).attr("y",function(a){return(a.y1+a.y0)/2}).attr("text-anchor","end").text(function(a){return a.name}).filter(function(b){return b.x0<a/2}).attr("x",
function(a){return a.x1+6}).attr("text-anchor","start")})};e.width=function(b){if(!arguments.length)return a;a=b;return e};e.height=function(a){if(!arguments.length)return d;d=a;return e};e.fill=function(a){if(!arguments.length)return c;c=a;return e};e.colors=function(a){if(!arguments.length)return f;f=a;return e};return e}
function wbScatterPlot(){var a=500,d=500,c=d3.scaleLinear(),f=d3.scaleLinear(),e=d3.scaleLinear(),b="green",k="red",m="x",r="y",g="x",u="white",l=function(){},p=void 0,h=[0,1],x=function(a){return a},v=function(a){return a},q=function(){},n=function(w){w.each(function(w,n,A){var y=d3.select(A[n]),t=d3.extent(w,function(a){return a[m]}),z=d3.extent(w,function(a){return a[r]}),D=d3.extent(w,function(a){return a[g]});y.selectAll(".datapoint").data(w).enter().append("a").attr("xlink:href",l).append("rect").attr("class",
"datapoint").attr("width",8).attr("height",8).attr("rx",5);y.append("g").attr("class","axis axis-x").attr("transform","translate(0,"+d+")");y.append("g").attr("class","axis axis-y");var C,E,H,I,F,G;q=function(l){l=l||!1;void 0!==p&&(I=d3.scaleLog().domain(d3.extent(w,function(a){return a[p]})).range(h));C=c.range([0,a]).domain(t);E=f.range([d,0]).domain(z);H=e.domain(D).interpolate(d3.interpolate).range([b,k]);G=d3.axisLeft(E);v(G);F=d3.axisBottom(C);x(F);y.select(".axis-x").transition().duration(500).call(F);
y.select(".axis-y").transition().duration(500).call(G);y.selectAll(".axis line").attr("stroke",u);y.selectAll(".axis path").attr("stroke",u);y.selectAll(".axis text").attr("fill",u);(l?y.selectAll(".datapoint"):y.selectAll(".datapoint").transition().duration(500)).attr("opacity",function(a){return void 0!==p?I(a[p]):1}).attr("x",function(a){return C(a[m])-4}).attr("y",function(a){return E(a[r])-4}).style("fill",function(a){return H(a[g])})};q(!0)})};n.width=function(b){if(!arguments.length)return a;
a=b;return n};n.height=function(a){if(!arguments.length)return d;d=a;return n};n.xAxisScale=function(a){if(!arguments.length)return c;c=a;return n};n.yAxisScale=function(a){if(!arguments.length)return f;f=a;return n};n.zAxisScale=function(a){if(!arguments.length)return e;e=a;return n};n.xDataPoints=function(a){if(!arguments.length)return m;m=a;return n};n.yDataPoints=function(a){if(!arguments.length)return r;r=a;return n};n.zDataPoints=function(a){if(!arguments.length)return g;g=a;return n};n.opacityDataPoints=
function(a){if(!arguments.length)return p;p=a;return n};n.opacityRange=function(a){if(!arguments.length)return h;h=a;return n};n.axisColor=function(a){if(!arguments.length)return u;u=a;return n};n.colorLow=function(a){if(!arguments.length)return b;b=a;return n};n.colorHigh=function(a){if(!arguments.length)return k;k=a;return n};n.href=function(a){if(!arguments.length)return l;l=a;return n};n.formatXAxis=function(a){if(!arguments.length)return x;x=a;return n};n.formatYAxis=function(a){if(!arguments.length)return v;
v=a;return n};n.update=function(){q();return n};return n}
function wbStackedBarChart(){var a=500,d=500,c="x",f="y",e=["red","green","blue"],b="black",k=0,m=0,r=[],g,u,l=!1,p=function(c){c.each(function(c,h,f){h=d3.select(f[h]);c.forEach(function(a,b){var c=Object.keys(a);for(b=a.total=0;b<c.length;++b)r.includes(c[b])||"id"==c[b]||(a.total+=+a[c[b]])});l&&c.sort(function(a,b){return b.total-a.total});g=d3.scaleBand().rangeRound([0,a]).paddingInner(.05).align(.1);u=d3.scaleLinear().rangeRound([d,0]);var p=d3.scaleOrdinal().range(e);g.domain(c.map(function(a){return a.id}));
u.domain([0,d3.max(c,function(a){return a.total})]).nice();f=c.columns.filter(function(a){return"id"!=a&&!r.includes(a)});p.domain(f);c=d3.stack().keys(f)(c);c.forEach(function(a){a.forEach(function(b){b.keyRef=a.key})});h.append("g").selectAll("g").data(c).enter().append("g").attr("fill",function(a){return p(a.key)}).selectAll("rect").data(function(a,b){return a}).enter().append("rect").attr("class","rects").attr("x",function(a){return g(a.data.id)}).attr("y",function(a){return u(a[1])}).attr("height",
function(a){return u(a[0])-u(a[1])}).attr("width",g.bandwidth());c=h.append("g").attr("font-size","75%").attr("text-anchor","end").attr("transform","translate("+k+","+m+")").selectAll("g").data(f.slice()).enter().append("g").attr("transform",function(a,b){return"translate(0,"+20*b+")"});c.append("rect").attr("x",-19).attr("width",19).attr("height",19).attr("fill",p);c.append("text").attr("x",-22).attr("y",9.5).attr("dy","0.32em").text(function(a){return a}).attr("fill",b)})};p.width=function(b){if(!arguments.length)return a;
a=b;return p};p.height=function(a){if(!arguments.length)return d;d=a;return p};p.xSelector=function(a){if(!arguments.length)return c;c=a;return p};p.ySelector=function(a){if(!arguments.length)return f;f=a;return p};p.scaleX=function(a){if(!arguments.length)return g;g=a;return p};p.scaleY=function(a){if(!arguments.length)return u;u=a;return p};p.colors=function(a){if(!arguments.length)return e;e=a;return p};p.legendFill=function(a){if(!arguments.length)return b;b=a;return p};p.legendX=function(a){if(!arguments.length)return k;
k=a;return p};p.legendY=function(a){if(!arguments.length)return m;m=a;return p};p.sortBySum=function(a){if(!arguments.length)return l;l=a;return p};p.ignoreColumns=function(a){if(!arguments.length)return r;r=a;return p};return p}
function wbStaticNumbers(){var a=500,d=500,c="black",f="red",e=function(b){b.each(function(b,e,r){e=d3.select(r[e]);var g=a/b.length,k=.1*a/(b.length-1);e.selectAll("number-value").data(b).enter().append("text").text(function(a){return a.name}).attr("x",function(a,b){return b*g}).attr("y",d).attr("text-anchor","left").attr("dominant-baseline","baseline").attr("fill",c).style("font-size","20px").style("font-weight","bold").text(function(a){return a.value}).style("font-size",function(a,b,c){a=c[b].getComputedTextLength();
return(g-k)/a*20+"px"}).each(function(a,b,c){a.numberBox=c[b].getBBox()});e.selectAll("number-label").data(b).enter().append("text").text(function(a){return a.name}).attr("x",function(a,b){return b*g}).attr("y",function(a){return d-a.numberBox.height+.25*a.numberBox.height}).attr("text-anchor","left").attr("fill",f).style("font-size","20px").text(function(a){return a.label}).style("font-size",function(a,b,c){a=c[b].getComputedTextLength();return(g-k)/a*20+"px"}).each(function(a,b,c){a.numberBox=c[b].getBBox()})})};
...
function wbTimeseries(){var a=500,d=500,c="hour",f="red",e="orange",b="black",k=void 0,m=d3.mean,r,g,u,l=function(l){l.each(function(h,l,p){l=d3.select(p[l]);var q=d3.extent(h,function(a){return a.date});h.forEach(function(a){a.month=a.date.getMonth();a.year=a.date.getFullYear();a.weekday=a.date.getDay();a.hour=a.date.getHours();a.minute=a.date.getMinutes();a.day=(new Date(a.date)).setHours(0,0,0,0);a["minute-of-day"]=(new Date(a.date)).setSeconds(0,0)});p=d3.extent(h,function(a){return a[c]});if("month"==
c){var n=d3.timeMonths(new Date(2017,0,1),new Date(2017,11,31));var w=d3.timeFormat("%B")}else if("year"==c){n=d3.timeYears(new Date(p[0],0,1),new Date(p[1],12,1));w=function(a){return a};var v=[];n.forEach(function(a){v.push(a.getFullYear())});n=v}else"weekday"==c?(n=[0,1,2,3,4,5,6],w=d3.timeFormat("%A")):"day"==c?(n=d3.timeDays(q[0],q[1]),w=d3.timeFormat("%d.%m.%Y")):"minute-of-day"==c&&(n=d3.timeMinutes(q[0]-6E4,q[1]),w=d3.timeFormat("%H:%M"));r=d3.scaleOrdinal().domain(n).range(d3.range(0,a,a/
n.length));var x=a/n.length*.1;h=d3.histogram().value(function(a){return a[c]}).thresholds(n)(h);p=d3.max(h,function(a){return a.length});g=d3.scaleLinear().range([d,0]).domain([0,p+1]);p=d3.extent(h,function(a){return a.length});var A=a/n.length-x;l.selectAll("rect").data(h).enter().append("rect").attr("class","rects").attr("x",0).attr("fill",function(a){return f}).attr("transform",function(a){return"translate("+r(a.x0)+","+g(a.length)+")"}).attr("width",function(a){return A}).attr("height",function(a){return d-
g(a.length)});if(k){h.forEach(function(a){var b=[];a.forEach(function(a){b=b.concat(a.value)});a.mean=m(b)});var B=d3.scaleOrdinal().domain(n).range(d3.range(0,a,a/n.length)),t=a/n.length*.8;p=d3.max(h,function(a){return a.mean});u=d3.scaleLinear().range([d,0]).domain([0,p+1]);l.selectAll(".dim").data(h).enter().append("rect").attr("class","valuerects").attr("fill",function(a){return e}).attr("transform",function(b){var c=A/2-a/n.length*.1;return"translate("+(B(b.x0)+c)+","+u(b.mean)+")"}).attr("width",
function(b){return a/n.length-t}).attr("height",function(a){return d-u(a.mean)})}l=l.append("g").attr("transform","translate(0,"+d+")").selectAll("xaxis").data(h).enter();l.append("line").attr("x1",0).attr("x2",a).style("stroke",b);l.append("text").text(function(a,b){if("weekday"!=c)return w(n[b]);a=d3.timeDays(new Date(2017,0,1),new Date(2017,0,8));return w(a[n[b]])}).style("text-anchor","middle").style("font-size","70%").style("fill",b).attr("x",function(b,c){return a/n.length*c+a/n.length/2-x/
2}).attr("y",function(a,b,c){return c[b].getBBox().height+5});l.append("line").attr("x1",function(b,c){return a/n.length*c+a/n.length/2-x/2}).attr("x2",function(b,c){return a/n.length*c+a/n.length/2-x/2}).attr("y1",0).attr("y2",5).style("stroke",b)})};l.width=function(b){if(!arguments.length)return a;a=b;return l};l.height=function(a){if(!arguments.length)return d;d=a;return l};l.target=function(a){if(!arguments.length)return c;c=a;return l};l.fill=function(a){if(!arguments.length)return f;f=a;return l};
l.fillValues=function(a){if(!arguments.length)return e;e=a;return l};l.fillAxis=function(a){if(!arguments.length)return b;b=a;return l};l.scaleX=function(a){if(!arguments.length)return r;r=a;return l};l.scaleY=function(a){if(!arguments.length)return g;g=a;return l};l.scaleY2=function(a){if(!arguments.length)return u;u=a;return l};l.valueColumn=function(a){if(!arguments.length)return k;k=a;return l};l.valueColumnAggregation=function(a){if(!arguments.length)return m;m=a;return l};return l}
